...
void copyinstr1(char *s)
{
    ...
    for (int ai = 0; ai < 2; ai++)
    {
      ...
      42:	0c250513          	addi	a0,a0,194 # 6100 <malloc+0xee>
      ...
      74:	8082                	ret
{
      ...
      84:	0a050513          	addi	a0,a0,160 # 6120 <malloc+0x10e>
...
000000000000009a <opentest>:
{
    ...
    fd = open("echo", 0);
      ...
      ac:	09050513          	addi	a0,a0,144 # 6138 <malloc+0x126>
    ...
    fd = open("doesnotexist", 0);
      ...
      ca:	09250513          	addi	a0,a0,146 # 6158 <malloc+0x146>
    ...
    if (fd >= 0)
      ...
      ea:	05a50513          	addi	a0,a0,90 # 6140 <malloc+0x12e>
     ...
     106:	06650513          	addi	a0,a0,102 # 6168 <malloc+0x156>
...
000000000000011c <truncate2>:
{
    ...
    unlink("truncfile");
     ...
     130:	06450513          	addi	a0,a0,100 # 6190 <malloc+0x17e>
     134:	00006097          	auipc	ra,0x6
     138:	adc080e7          	jalr	-1316(ra) # 5c10 <unlink>
    int fd1 = open("truncfile", O_CREATE | O_TRUNC | O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	05050513          	addi	a0,a0,80 # 6190 <malloc+0x17e>
    ...
    write(fd1, "abcd", 4);
     ...
     158:	04c58593          	addi	a1,a1,76 # 61a0 <malloc+0x18e>
     15c:	00006097          	auipc	ra,0x6
     160:	a84080e7          	jalr	-1404(ra) # 5be0 <write>
    int fd2 = open("truncfile", O_TRUNC | O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	02850513          	addi	a0,a0,40 # 6190 <malloc+0x17e>
    ...
    int n = write(fd1, "x", 1);
     ...
     180:	02c58593          	addi	a1,a1,44 # 61a8 <malloc+0x196>
     184:	8526                	mv	a0,s1
    ...
    unlink("truncfile");
     ...
     198:	ffc50513          	addi	a0,a0,-4 # 6190 <malloc+0x17e>
    ...
    close(fd2);
     ...
     1ce:	fe650513          	addi	a0,a0,-26 # 61b0 <malloc+0x19e>
...
0000000000000264 <bigwrite>:
{
    ...
    unlink("bigwrite");
     ...
     280:	f5c50513          	addi	a0,a0,-164 # 61d8 <malloc+0x1c6>
    ...
    for (sz = 499; sz < (MAXOPBLOCKS + 2) * BSIZE; sz += 471)
     ...
     294:	f48a8a93          	addi	s5,s5,-184 # 61d8 <malloc+0x1c6>
    ...
    for (sz = 499; sz < (MAXOPBLOCKS + 2) * BSIZE; sz += 471)
     ...
     316:	ed650513          	addi	a0,a0,-298 # 61e8 <malloc+0x1d6>
     ...
     338:	ed450513          	addi	a0,a0,-300 # 6208 <malloc+0x1f6>
...
void badwrite(char *s)
{
    ...
    unlink("junk");
     ...
     362:	ec250513          	addi	a0,a0,-318 # 6220 <malloc+0x20e>
    ...
    for (int i = 0; i < assumed_free; i++)
    {
     ...
     376:	eae98993          	addi	s3,s3,-338 # 6220 <malloc+0x20e>
        if (fd < 0)
        {
    ...
    int fd = open("junk", O_CREATE | O_WRONLY);
     ...
     3c2:	e6250513          	addi	a0,a0,-414 # 6220 <malloc+0x20e>
    ...
    if (write(fd, "x", 1) != 1)
     ...
     3da:	dd258593          	addi	a1,a1,-558 # 61a8 <malloc+0x196>
     ...
     3e8:	04f50963          	beq	a0,a5,43a <badwrite+0xec>
    {
     ...
     3f0:	e5450513          	addi	a0,a0,-428 # 6240 <malloc+0x22e>
     ...
     40a:	e2250513          	addi	a0,a0,-478 # 6228 <malloc+0x216>
     ...
     424:	e0850513          	addi	a0,a0,-504 # 6228 <malloc+0x216>
    ...
    unlink("junk");
     ...
     448:	ddc50513          	addi	a0,a0,-548 # 6220 <malloc+0x20e>
...
000000000000052e <copyin>:
{
    ...
    for (int ai = 0; ai < 2; ai++)
     ...
     554:	d00a0a13          	addi	s4,s4,-768 # 6250 <malloc+0x23e>
        uint64 addr = addrs[ai];
    ...
    for (int ai = 0; ai < 2; ai++)
     ...
     600:	c5c50513          	addi	a0,a0,-932 # 6258 <malloc+0x246>
     ...
     61e:	c5650513          	addi	a0,a0,-938 # 6270 <malloc+0x25e>
     ...
     63c:	c6850513          	addi	a0,a0,-920 # 62a0 <malloc+0x28e>
     ...
     656:	c7e50513          	addi	a0,a0,-898 # 62d0 <malloc+0x2be>
     ...
     674:	c7050513          	addi	a0,a0,-912 # 62e0 <malloc+0x2ce>
...
000000000000068a <copyout>:
{
    ...
    for (int ai = 0; ai < 2; ai++)
     ...
     6b2:	c62a0a13          	addi	s4,s4,-926 # 6310 <malloc+0x2fe>
        n = write(fds[1], "x", 1);
     6b6:	00006a97          	auipc	s5,0x6
     6ba:	af2a8a93          	addi	s5,s5,-1294 # 61a8 <malloc+0x196>
        uint64 addr = addrs[ai];
    ...
    for (int ai = 0; ai < 2; ai++)
     ...
     760:	bbc50513          	addi	a0,a0,-1092 # 6318 <malloc+0x306>
     ...
     77e:	bb650513          	addi	a0,a0,-1098 # 6330 <malloc+0x31e>
     ...
     798:	b3c50513          	addi	a0,a0,-1220 # 62d0 <malloc+0x2be>
     ...
     7b2:	bb250513          	addi	a0,a0,-1102 # 6360 <malloc+0x34e>
     ...
     7d0:	bac50513          	addi	a0,a0,-1108 # 6378 <malloc+0x366>
...
00000000000007e6 <truncate1>:
{
    ...
    write(fd1, "abcd", 4);
     ...
     826:	97e58593          	addi	a1,a1,-1666 # 61a0 <malloc+0x18e>
    ...
    int fd2 = open("truncfile", O_RDONLY);
     ...
     842:	95250513          	addi	a0,a0,-1710 # 6190 <malloc+0x17e>
    ...
    fd1 = open("truncfile", O_WRONLY | O_TRUNC);
     ...
     86e:	92650513          	addi	a0,a0,-1754 # 6190 <malloc+0x17e>
    ...
    int fd3 = open("truncfile", O_RDONLY);
     ...
     882:	91250513          	addi	a0,a0,-1774 # 6190 <malloc+0x17e>
    ...
    write(fd1, "abcdef", 6);
     ...
     8c0:	b4c58593          	addi	a1,a1,-1204 # 6408 <malloc+0x3f6>
     8c4:	854e                	mv	a0,s3
    ...
    unlink("truncfile");
     ...
     902:	89250513          	addi	a0,a0,-1902 # 6190 <malloc+0x17e>
    ...
    close(fd3);
     ...
     946:	a6650513          	addi	a0,a0,-1434 # 63a8 <malloc+0x396>
     ...
     962:	a6a50513          	addi	a0,a0,-1430 # 63c8 <malloc+0x3b6>
     ...
     976:	a6650513          	addi	a0,a0,-1434 # 63d8 <malloc+0x3c6>
     ...
     992:	a6a50513          	addi	a0,a0,-1430 # 63f8 <malloc+0x3e6>
     ...
     9a6:	a3650513          	addi	a0,a0,-1482 # 63d8 <malloc+0x3c6>
     ...
     9c4:	a5050513          	addi	a0,a0,-1456 # 6410 <malloc+0x3fe>
     ...
     9e2:	a5250513          	addi	a0,a0,-1454 # 6430 <malloc+0x41e>
...
00000000000009f8 <writetest>:
{
    ...
    fd = open("small", O_CREATE | O_RDWR);
     ...
     a16:	a3e50513          	addi	a0,a0,-1474 # 6450 <malloc+0x43e>
    ...
    if (fd < 0)
     ...
     a2e:	a4e98993          	addi	s3,s3,-1458 # 6478 <malloc+0x466>
        if (write(fd, "bbbbbbbbbb", SZ) != SZ)
     a32:	00006a97          	auipc	s5,0x6
     a36:	a7ea8a93          	addi	s5,s5,-1410 # 64b0 <malloc+0x49e>
    for (i = 0; i < N; i++)
    ...
    fd = open("small", O_RDONLY);
     ...
     a7c:	9d850513          	addi	a0,a0,-1576 # 6450 <malloc+0x43e>
    ...
    if (unlink("small") < 0)
     ...
     ab8:	99c50513          	addi	a0,a0,-1636 # 6450 <malloc+0x43e>
     ...
     ae2:	97a50513          	addi	a0,a0,-1670 # 6458 <malloc+0x446>
     ...
     b00:	98c50513          	addi	a0,a0,-1652 # 6488 <malloc+0x476>
     ...
     b1e:	9a650513          	addi	a0,a0,-1626 # 64c0 <malloc+0x4ae>
     ...
     b3a:	9b250513          	addi	a0,a0,-1614 # 64e8 <malloc+0x4d6>
     ...
     b56:	9b650513          	addi	a0,a0,-1610 # 6508 <malloc+0x4f6>
     ...
     b72:	9b250513          	addi	a0,a0,-1614 # 6520 <malloc+0x50e>
...
0000000000000b88 <writebig>:
{
    ...
    fd = open("big", O_CREATE | O_RDWR);
     ...
     ba4:	9a050513          	addi	a0,a0,-1632 # 6540 <malloc+0x52e>
    ...
    fd = open("big", O_RDONLY);
     ...
     bf6:	94e50513          	addi	a0,a0,-1714 # 6540 <malloc+0x52e>
    ...
    if (fd < 0)
     ...
     c3e:	90e50513          	addi	a0,a0,-1778 # 6548 <malloc+0x536>
     ...
     c5c:	91050513          	addi	a0,a0,-1776 # 6568 <malloc+0x556>
     ...
     c78:	91c50513          	addi	a0,a0,-1764 # 6590 <malloc+0x57e>
    ...
    if (unlink("big") < 0)
     ...
     ca4:	8a050513          	addi	a0,a0,-1888 # 6540 <malloc+0x52e>
     ...
     cd0:	8e450513          	addi	a0,a0,-1820 # 65b0 <malloc+0x59e>
     ...
     cee:	8ee50513          	addi	a0,a0,-1810 # 65d8 <malloc+0x5c6>
     ...
     d0c:	8e850513          	addi	a0,a0,-1816 # 65f0 <malloc+0x5de>
     ...
     d28:	8f450513          	addi	a0,a0,-1804 # 6618 <malloc+0x606>
...
0000000000000d3e <unlinkread>:
{
    ...
    fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     d56:	8de50513          	addi	a0,a0,-1826 # 6630 <malloc+0x61e>
    ...
    write(fd, "hello", SZ);
     ...
     d6e:	8f658593          	addi	a1,a1,-1802 # 6660 <malloc+0x64e>
    ...
    fd = open("unlinkread", O_RDWR);
     ...
     d8a:	8aa50513          	addi	a0,a0,-1878 # 6630 <malloc+0x61e>
    ...
    if (unlink("unlinkread") != 0)
     ...
     da0:	89450513          	addi	a0,a0,-1900 # 6630 <malloc+0x61e>
    ...
    fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     db6:	87e50513          	addi	a0,a0,-1922 # 6630 <malloc+0x61e>
    ...
    write(fd1, "yyy", 3);
     ...
     dca:	8e258593          	addi	a1,a1,-1822 # 66a8 <malloc+0x696>
    ...
    unlink("unlinkread");
     ...
     e32:	80250513          	addi	a0,a0,-2046 # 6630 <malloc+0x61e>
     ...
     e52:	7f250513          	addi	a0,a0,2034 # 6640 <malloc+0x62e>
     ...
     e6e:	7fe50513          	addi	a0,a0,2046 # 6668 <malloc+0x656>
     ...
     e8a:	80250513          	addi	a0,a0,-2046 # 6688 <malloc+0x676>
     ...
     ea6:	80e50513          	addi	a0,a0,-2034 # 66b0 <malloc+0x69e>
     ...
     ec2:	81250513          	addi	a0,a0,-2030 # 66d0 <malloc+0x6be>
     ...
     ede:	81650513          	addi	a0,a0,-2026 # 66f0 <malloc+0x6de>
...
0000000000000ef4 <linktest>:
{
    ...
    if (write(fd, "hello", SZ) != SZ)
     ...
     f42:	72258593          	addi	a1,a1,1826 # 6660 <malloc+0x64e>
    ...
    if (link("lf1", "lf2") < 0)
     ...
     f62:	7ba58593          	addi	a1,a1,1978 # 6718 <malloc+0x706>
     f66:	00005517          	auipc	a0,0x5
     f6a:	7aa50513          	addi	a0,a0,1962 # 6710 <malloc+0x6fe>
    ...
    unlink("lf1");
     ...
     f7e:	79650513          	addi	a0,a0,1942 # 6710 <malloc+0x6fe>
     f82:	00005097          	auipc	ra,0x5
     f86:	c8e080e7          	jalr	-882(ra) # 5c10 <unlink>
    if (open("lf1", 0) >= 0)
     f8a:	4581                	li	a1,0
     f8c:	00005517          	auipc	a0,0x5
     f90:	78450513          	addi	a0,a0,1924 # 6710 <malloc+0x6fe>
    ...
    fd = open("lf2", 0);
     ...
     fa6:	77650513          	addi	a0,a0,1910 # 6718 <malloc+0x706>
    ...
    if (link("lf2", "lf2") >= 0)
     ...
     fde:	73e58593          	addi	a1,a1,1854 # 6718 <malloc+0x706>
     fe2:	852e                	mv	a0,a1
    ...
    unlink("lf2");
     ...
     ff4:	72850513          	addi	a0,a0,1832 # 6718 <malloc+0x706>
     ff8:	00005097          	auipc	ra,0x5
     ffc:	c18080e7          	jalr	-1000(ra) # 5c10 <unlink>
    if (link("lf2", "lf1") >= 0)
    1000:	00005597          	auipc	a1,0x5
    1004:	71058593          	addi	a1,a1,1808 # 6710 <malloc+0x6fe>
    1008:	00005517          	auipc	a0,0x5
    100c:	71050513          	addi	a0,a0,1808 # 6718 <malloc+0x706>
    ...
    1020:	6f458593          	addi	a1,a1,1780 # 6710 <malloc+0x6fe>
    1024:	00005517          	auipc	a0,0x5
    1028:	7fc50513          	addi	a0,a0,2044 # 6820 <malloc+0x80e>
    ...
    104a:	6da50513          	addi	a0,a0,1754 # 6720 <malloc+0x70e>
    ...
    1066:	6d650513          	addi	a0,a0,1750 # 6738 <malloc+0x726>
    ...
    1082:	6d250513          	addi	a0,a0,1746 # 6750 <malloc+0x73e>
    ...
    109e:	6d650513          	addi	a0,a0,1750 # 6770 <malloc+0x75e>
    ...
    10ba:	6ea50513          	addi	a0,a0,1770 # 67a0 <malloc+0x78e>
    ...
    10d6:	6e650513          	addi	a0,a0,1766 # 67b8 <malloc+0x7a6>
    ...
    10f2:	6e250513          	addi	a0,a0,1762 # 67d0 <malloc+0x7be>
    ...
    110e:	6ee50513          	addi	a0,a0,1774 # 67f8 <malloc+0x7e6>
    ...
    112a:	70250513          	addi	a0,a0,1794 # 6828 <malloc+0x816>
...
0000000000001140 <validatetest>:
{
    ...
    115c:	6f098993          	addi	s3,s3,1776 # 6848 <malloc+0x836>
    1160:	597d                	li	s2,-1
    for (p = 0; p <= (uint)hi; p += PGSIZE)
    ...
    1198:	6c450513          	addi	a0,a0,1732 # 6858 <malloc+0x846>
...
00000000000011ae <bigdir>:
{
    ...
    11fe:	67ea0a13          	addi	s4,s4,1662 # 6878 <malloc+0x866>
    for (i = 0; i < N; i++)
    ...
    1250:	62c50513          	addi	a0,a0,1580 # 6878 <malloc+0x866>
    ...
    12c0:	5c450513          	addi	a0,a0,1476 # 6880 <malloc+0x86e>
    ...
    12e0:	5c450513          	addi	a0,a0,1476 # 68a0 <malloc+0x88e>
    ...
    12fc:	5c850513          	addi	a0,a0,1480 # 68c0 <malloc+0x8ae>
...
000000000000134a <badarg>:
{
    ...
    1368:	dd498993          	addi	s3,s3,-556 # 6138 <malloc+0x126>
        argv[0] = (char *)0xffffffff;
...
0000000000001390 <copyinstr2>:
{
    ...
    13f2:	72a78793          	addi	a5,a5,1834 # 7b18 <malloc+0x1b06>
    ...
    144e:	10e78793          	addi	a5,a5,270 # 8558 <malloc+0x2546>
    ...
    1472:	cca50513          	addi	a0,a0,-822 # 6138 <malloc+0x126>
    ...
    148a:	4e250513          	addi	a0,a0,1250 # 6968 <malloc+0x956>
    ...
    14aa:	43a50513          	addi	a0,a0,1082 # 68e0 <malloc+0x8ce>
    ...
    14ca:	43a50513          	addi	a0,a0,1082 # 6900 <malloc+0x8ee>
    ...
    14ec:	43850513          	addi	a0,a0,1080 # 6920 <malloc+0x90e>
    ...
    150c:	44050513          	addi	a0,a0,1088 # 6948 <malloc+0x936>
    ...
    1526:	8a650513          	addi	a0,a0,-1882 # 6dc8 <malloc+0xdb6>
    ...
    1570:	42450513          	addi	a0,a0,1060 # 6990 <malloc+0x97e>
...
0000000000001586 <truncate3>:
{
    ...
    15a2:	bf250513          	addi	a0,a0,-1038 # 6190 <malloc+0x17e>
    ...
    15cc:	bc8a0a13          	addi	s4,s4,-1080 # 6190 <malloc+0x17e>
            int n = write(fd, "1234567890", 10);
    15d0:	00005a97          	auipc	s5,0x5
    15d4:	420a8a93          	addi	s5,s5,1056 # 69f0 <malloc+0x9de>
            int fd = open("truncfile", O_WRONLY);
    15d8:	4585                	li	a1,1
    15da:	8552                	mv	a0,s4
    ...
    1644:	38050513          	addi	a0,a0,896 # 69c0 <malloc+0x9ae>
    ...
    1660:	37c50513          	addi	a0,a0,892 # 69d8 <malloc+0x9c6>
    ...
    167e:	38650513          	addi	a0,a0,902 # 6a00 <malloc+0x9ee>
    ...
    169c:	af8a0a13          	addi	s4,s4,-1288 # 6190 <malloc+0x17e>
        int n = write(fd, "xxx", 3);
    16a0:	00005a97          	auipc	s5,0x5
    16a4:	380a8a93          	addi	s5,s5,896 # 6a20 <malloc+0xa0e>
        int fd = open("truncfile", O_CREATE | O_WRONLY | O_TRUNC);
    ...
    16ee:	aa650513          	addi	a0,a0,-1370 # 6190 <malloc+0x17e>
    ...
    170c:	2d050513          	addi	a0,a0,720 # 69d8 <malloc+0x9c6>
    ...
    172a:	30250513          	addi	a0,a0,770 # 6a28 <malloc+0xa16>
...
0000000000001740 <exectest>:
{
    ...
    1752:	9ea78793          	addi	a5,a5,-1558 # 6138 <malloc+0x126>
    1756:	fcf43023          	sd	a5,-64(s0)
    175a:	00005797          	auipc	a5,0x5
    175e:	2ee78793          	addi	a5,a5,750 # 6a48 <malloc+0xa36>
    1762:	fcf43423          	sd	a5,-56(s0)
    1766:	fc043823          	sd	zero,-48(s0)
    unlink("echo-ok");
    176a:	00005517          	auipc	a0,0x5
    176e:	2e650513          	addi	a0,a0,742 # 6a50 <malloc+0xa3e>
    ...
    179c:	2b850513          	addi	a0,a0,696 # 6a50 <malloc+0xa3e>
    ...
    17b8:	2bc50513          	addi	a0,a0,700 # 6a70 <malloc+0xa5e>
    ...
    17d4:	1f050513          	addi	a0,a0,496 # 69c0 <malloc+0x9ae>
    ...
    17f0:	26c50513          	addi	a0,a0,620 # 6a58 <malloc+0xa46>
    ...
    180e:	92e50513          	addi	a0,a0,-1746 # 6138 <malloc+0x126>
    ...
    1842:	24250513          	addi	a0,a0,578 # 6a80 <malloc+0xa6e>
    ...
    185e:	23e50513          	addi	a0,a0,574 # 6a98 <malloc+0xa86>
    ...
    1872:	1e250513          	addi	a0,a0,482 # 6a50 <malloc+0xa3e>
    ...
    189c:	c7050513          	addi	a0,a0,-912 # 6508 <malloc+0x4f6>
    ...
    18b8:	12450513          	addi	a0,a0,292 # 69d8 <malloc+0x9c6>
    ...
    18d2:	18250513          	addi	a0,a0,386 # 6a50 <malloc+0xa3e>
    ...
    18fc:	1b850513          	addi	a0,a0,440 # 6ab0 <malloc+0xa9e>
...
000000000000191c <pipe1>:
{
    ...
    19bc:	11050513          	addi	a0,a0,272 # 6ac8 <malloc+0xab6>
    ...
    19f6:	42da8a93          	addi	s5,s5,1069 # 142d <copyinstr2+0x9d>
{
    ...
    1a42:	0a250513          	addi	a0,a0,162 # 6ae0 <malloc+0xace>
    ...
    1a5e:	09e50513          	addi	a0,a0,158 # 6af8 <malloc+0xae6>
    ...
    1a90:	08450513          	addi	a0,a0,132 # 6b10 <malloc+0xafe>
    ...
    1ad0:	06450513          	addi	a0,a0,100 # 6b30 <malloc+0xb1e>
...
0000000000001ae6 <exitwait>:
{
    ...
    1b42:	e8250513          	addi	a0,a0,-382 # 69c0 <malloc+0x9ae>
    ...
    1b5e:	fee50513          	addi	a0,a0,-18 # 6b48 <malloc+0xb36>
    ...
    1b7a:	fea50513          	addi	a0,a0,-22 # 6b60 <malloc+0xb4e>
...
0000000000001b9a <twochildren>:
{
    ...
    1bf2:	dd250513          	addi	a0,a0,-558 # 69c0 <malloc+0x9ae>
    ...
    1c16:	dae50513          	addi	a0,a0,-594 # 69c0 <malloc+0x9ae>
...
0000000000001c34 <forkfork>:
{
    ...
    1c90:	ef450513          	addi	a0,a0,-268 # 6b80 <malloc+0xb6e>
    ...
    1ca2:	f22080e7          	jalr	-222(ra) # 5bc0 <exit>
{
    ...
    1ce8:	eac50513          	addi	a0,a0,-340 # 6b90 <malloc+0xb7e>
...
0000000000001cfe <reparent2>:
{
    ...
    1d36:	09650513          	addi	a0,a0,150 # 6dc8 <malloc+0xdb6>
...
0000000000001d66 <createdelete>:
{
    ...
    1dd4:	ff850513          	addi	a0,a0,-8 # 6dc8 <malloc+0xdb6>
    ...
    1e00:	c5c50513          	addi	a0,a0,-932 # 6a58 <malloc+0xa46>
    ...
    1e72:	d4250513          	addi	a0,a0,-702 # 6bb0 <malloc+0xb9e>
    ...
    1ea6:	d2650513          	addi	a0,a0,-730 # 6bc8 <malloc+0xbb6>
    ...
    1f0c:	ce850513          	addi	a0,a0,-792 # 6bf0 <malloc+0xbde>
...
0000000000001f8c <linkunlink>:
{
    ...
    1fac:	20050513          	addi	a0,a0,512 # 61a8 <malloc+0x196>
    ...
    1fe8:	1c4a8a93          	addi	s5,s5,452 # 61a8 <malloc+0x196>
            link("cat", "x");
    1fec:	00005b97          	auipc	s7,0x5
    1ff0:	c2cb8b93          	addi	s7,s7,-980 # 6c18 <malloc+0xc06>
    1ff4:	a825                	j	202c <linkunlink+0xa0>
        printf("%s: fork failed\n", s);
    1ff6:	85a6                	mv	a1,s1
    1ff8:	00005517          	auipc	a0,0x5
    1ffc:	9c850513          	addi	a0,a0,-1592 # 69c0 <malloc+0x9ae>
...
000000000000208e <forktest>:
{
    ...
    20be:	b7e50513          	addi	a0,a0,-1154 # 6c38 <malloc+0xc26>
    ...
    2120:	b0450513          	addi	a0,a0,-1276 # 6c20 <malloc+0xc0e>
    ...
    213c:	b2850513          	addi	a0,a0,-1240 # 6c60 <malloc+0xc4e>
    ...
    2158:	b2450513          	addi	a0,a0,-1244 # 6c78 <malloc+0xc66>
...
000000000000216e <kernmem>:
{
    ...
    21d8:	7ec50513          	addi	a0,a0,2028 # 69c0 <malloc+0x9ae>
    ...
    21fa:	a9a50513          	addi	a0,a0,-1382 # 6c90 <malloc+0xc7e>
...
000000000000221a <MAXVAplus>:
{
    ...
    227c:	74850513          	addi	a0,a0,1864 # 69c0 <malloc+0x9ae>
    ...
    22a8:	a0c50513          	addi	a0,a0,-1524 # 6cb0 <malloc+0xc9e>
...
00000000000022c8 <bigargtest>:
{
    ...
    22d8:	9f450513          	addi	a0,a0,-1548 # 6cc8 <malloc+0xcb6>
    ...
    230a:	9c250513          	addi	a0,a0,-1598 # 6cc8 <malloc+0xcb6>
    ...
    2340:	99c70713          	addi	a4,a4,-1636 # 6cd8 <malloc+0xcc6>
    ...
    2394:	a2850513          	addi	a0,a0,-1496 # 6db8 <malloc+0xda6>
    ...
    23b8:	a2450513          	addi	a0,a0,-1500 # 6dd8 <malloc+0xdc6>
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    2416:	9e650513          	addi	a0,a0,-1562 # 6df8 <malloc+0xde6>
    ...
    2432:	59250513          	addi	a0,a0,1426 # 69c0 <malloc+0x9ae>
...
0000000000002452 <textwrite>:
{
    ...
    24a0:	52450513          	addi	a0,a0,1316 # 69c0 <malloc+0x9ae>
...
00000000000024c0 <manywrites>:
{
    ...
    251c:	8b050513          	addi	a0,a0,-1872 # 6dc8 <malloc+0xdb6>
    ...
    25cc:	85850513          	addi	a0,a0,-1960 # 6e20 <malloc+0xe0e>
    ...
    25ec:	c2050513          	addi	a0,a0,-992 # 6208 <malloc+0x1f6>
...
000000000000260a <copyinstr3>:
{
    ...
    *b = 'x';
    ...
    2684:	49878793          	addi	a5,a5,1176 # 7b18 <malloc+0x1b06>
    ...
    26c6:	77650513          	addi	a0,a0,1910 # 6e38 <malloc+0xe26>
    ...
    26e4:	20050513          	addi	a0,a0,512 # 68e0 <malloc+0x8ce>
    ...
    2702:	20250513          	addi	a0,a0,514 # 6900 <malloc+0x8ee>
    ...
    2722:	20250513          	addi	a0,a0,514 # 6920 <malloc+0x90e>
    ...
    2740:	20c50513          	addi	a0,a0,524 # 6948 <malloc+0x936>
...
0000000000002756 <rwsbrk>:
{
    ...
    278c:	6f050513          	addi	a0,a0,1776 # 6e78 <malloc+0xe66>
    ...
    27bc:	6e050513          	addi	a0,a0,1760 # 6e98 <malloc+0xe86>
    ...
    27d6:	66e50513          	addi	a0,a0,1646 # 6e40 <malloc+0xe2e>
    ...
    27f0:	66c50513          	addi	a0,a0,1644 # 6e58 <malloc+0xe46>
    ...
    280a:	67a50513          	addi	a0,a0,1658 # 6e80 <malloc+0xe6e>
    ...
    282e:	64e50513          	addi	a0,a0,1614 # 6e78 <malloc+0xe66>
    2832:	00003097          	auipc	ra,0x3
    2836:	3de080e7          	jalr	990(ra) # 5c10 <unlink>
    fd = open("README", O_RDONLY);
    283a:	4581                	li	a1,0
    283c:	00004517          	auipc	a0,0x4
    2840:	ad450513          	addi	a0,a0,-1324 # 6310 <malloc+0x2fe>
    ...
    286a:	66250513          	addi	a0,a0,1634 # 6ec8 <malloc+0xeb6>
    ...
    2884:	60050513          	addi	a0,a0,1536 # 6e80 <malloc+0xe6e>
...
00000000000028ae <sbrkbasic>:
{
    ...
    2904:	5f050513          	addi	a0,a0,1520 # 6ef0 <malloc+0xede>
    ...
    2956:	5be50513          	addi	a0,a0,1470 # 6f10 <malloc+0xefe>
    ...
    29ba:	5ba50513          	addi	a0,a0,1466 # 6f70 <malloc+0xf5e>
    ...
    29dc:	55850513          	addi	a0,a0,1368 # 6f30 <malloc+0xf1e>
    ...
    29f8:	55c50513          	addi	a0,a0,1372 # 6f50 <malloc+0xf3e>
...
0000000000002a34 <sbrkmuch>:
{
    ...
    *lastaddr = 99;
    ...
    2b42:	45250513          	addi	a0,a0,1106 # 6f90 <malloc+0xf7e>
    ...
    2b5e:	47e50513          	addi	a0,a0,1150 # 6fd8 <malloc+0xfc6>
    ...
    2b7e:	47e50513          	addi	a0,a0,1150 # 6ff8 <malloc+0xfe6>
    ...
    2b9e:	49e50513          	addi	a0,a0,1182 # 7038 <malloc+0x1026>
    ...
    2bba:	4b250513          	addi	a0,a0,1202 # 7068 <malloc+0x1056>
    ...
    2bda:	4ca50513          	addi	a0,a0,1226 # 70a0 <malloc+0x108e>
...
0000000000002bf0 <sbrkarg>:
{
    ...
    2c14:	4b850513          	addi	a0,a0,1208 # 70c8 <malloc+0x10b6>
    2c18:	00003097          	auipc	ra,0x3
    2c1c:	fe8080e7          	jalr	-24(ra) # 5c00 <open>
    2c20:	84aa                	mv	s1,a0
    unlink("sbrk");
    2c22:	00004517          	auipc	a0,0x4
    2c26:	4a650513          	addi	a0,a0,1190 # 70c8 <malloc+0x10b6>
    ...
    2c7a:	45a50513          	addi	a0,a0,1114 # 70d0 <malloc+0x10be>
    ...
    2c96:	45650513          	addi	a0,a0,1110 # 70e8 <malloc+0x10d6>
    ...
    2cb2:	e1a50513          	addi	a0,a0,-486 # 6ac8 <malloc+0xab6>
...
0000000000002cc8 <argptest>:
{
    ...
    2cdc:	42850513          	addi	a0,a0,1064 # 7100 <malloc+0x10ee>
    ...
    2d24:	cb850513          	addi	a0,a0,-840 # 69d8 <malloc+0x9c6>
...
0000000000002d3a <sbrkbugs>:
{
    ...
    2d72:	05a50513          	addi	a0,a0,90 # 6dc8 <malloc+0xdb6>
    ...
    2dc8:	00450513          	addi	a0,a0,4 # 6dc8 <malloc+0xdb6>
    ...
    2e28:	fa450513          	addi	a0,a0,-92 # 6dc8 <malloc+0xdb6>
...
0000000000002f5a <execout>:
{
    ...
    2f9c:	e3050513          	addi	a0,a0,-464 # 6dc8 <malloc+0xdb6>
    ...
    2ff0:	14c50513          	addi	a0,a0,332 # 6138 <malloc+0x126>
    2ff4:	faa43c23          	sd	a0,-72(s0)
    2ff8:	00003797          	auipc	a5,0x3
    2ffc:	1b078793          	addi	a5,a5,432 # 61a8 <malloc+0x196>
...
000000000000301e <fourteen>:
{
    ...
    302e:	2ae50513          	addi	a0,a0,686 # 72d8 <malloc+0x12c6>
    ...
    3040:	0f450513          	addi	a0,a0,244 # 7130 <malloc+0x111e>
    ...
    3056:	13650513          	addi	a0,a0,310 # 7188 <malloc+0x1176>
    ...
    3074:	19050513          	addi	a0,a0,400 # 7200 <malloc+0x11ee>
    ...
    3090:	1e450513          	addi	a0,a0,484 # 7270 <malloc+0x125e>
    ...
    30a2:	22a50513          	addi	a0,a0,554 # 72c8 <malloc+0x12b6>
    ...
    3120:	fec50513          	addi	a0,a0,-20 # 7108 <malloc+0x10f6>
    ...
    313c:	01850513          	addi	a0,a0,24 # 7150 <malloc+0x113e>
    ...
    3158:	06450513          	addi	a0,a0,100 # 71b8 <malloc+0x11a6>
    ...
    3174:	0c050513          	addi	a0,a0,192 # 7230 <malloc+0x121e>
    ...
    3190:	10450513          	addi	a0,a0,260 # 7290 <malloc+0x127e>
    ...
    31ac:	14050513          	addi	a0,a0,320 # 72e8 <malloc+0x12d6>
...
00000000000031c2 <diskfull>:
{
    ...
    31f8:	12c50513          	addi	a0,a0,300 # 7320 <malloc+0x130e>
    ...
    3222:	11250513          	addi	a0,a0,274 # 7330 <malloc+0x131e>
    ...
    32b2:	07250513          	addi	a0,a0,114 # 7320 <malloc+0x130e>
    ...
    32c6:	05e50513          	addi	a0,a0,94 # 7320 <malloc+0x130e>
    ...
    33f4:	f6050513          	addi	a0,a0,-160 # 7350 <malloc+0x133e>
...
0000000000003402 <iputtest>:
{
    ...
    3412:	f7250513          	addi	a0,a0,-142 # 7380 <malloc+0x136e>
    ...
    3426:	f5e50513          	addi	a0,a0,-162 # 7380 <malloc+0x136e>
    ...
    343a:	f8a50513          	addi	a0,a0,-118 # 73c0 <malloc+0x13ae>
    ...
    344e:	fa650513          	addi	a0,a0,-90 # 73f0 <malloc+0x13de>
    ...
    346e:	f1e50513          	addi	a0,a0,-226 # 7388 <malloc+0x1376>
    ...
    348a:	f1a50513          	addi	a0,a0,-230 # 73a0 <malloc+0x138e>
    ...
    34a6:	f2e50513          	addi	a0,a0,-210 # 73d0 <malloc+0x13be>
    ...
    34c2:	f3a50513          	addi	a0,a0,-198 # 73f8 <malloc+0x13e6>
...
00000000000034d8 <exitiputtest>:
{
    ...
    34f6:	e8e50513          	addi	a0,a0,-370 # 7380 <malloc+0x136e>
    ...
    350a:	e7a50513          	addi	a0,a0,-390 # 7380 <malloc+0x136e>
    ...
    351e:	ea650513          	addi	a0,a0,-346 # 73c0 <malloc+0x13ae>
    ...
    353e:	48650513          	addi	a0,a0,1158 # 69c0 <malloc+0x9ae>
    ...
    355a:	e3250513          	addi	a0,a0,-462 # 7388 <malloc+0x1376>
    ...
    3576:	e9e50513          	addi	a0,a0,-354 # 7410 <malloc+0x13fe>
    ...
    3592:	e4250513          	addi	a0,a0,-446 # 73d0 <malloc+0x13be>
...
00000000000035c0 <dirtest>:
{
    ...
    35d0:	e5c50513          	addi	a0,a0,-420 # 7428 <malloc+0x1416>
    ...
    35e4:	e4850513          	addi	a0,a0,-440 # 7428 <malloc+0x1416>
    ...
    35f8:	e5450513          	addi	a0,a0,-428 # 7448 <malloc+0x1436>
    ...
    360c:	e2050513          	addi	a0,a0,-480 # 7428 <malloc+0x1416>
    ...
    362c:	d6050513          	addi	a0,a0,-672 # 7388 <malloc+0x1376>
    ...
    3648:	dec50513          	addi	a0,a0,-532 # 7430 <malloc+0x141e>
    ...
    3664:	df050513          	addi	a0,a0,-528 # 7450 <malloc+0x143e>
    ...
    3680:	dec50513          	addi	a0,a0,-532 # 7468 <malloc+0x1456>
...
0000000000003696 <subdir>:
{
    ...
    36a8:	f0c50513          	addi	a0,a0,-244 # 75b0 <malloc+0x159e>
    36ac:	00002097          	auipc	ra,0x2
    36b0:	564080e7          	jalr	1380(ra) # 5c10 <unlink>
    if (mkdir("dd") != 0)
    36b4:	00004517          	auipc	a0,0x4
    36b8:	dcc50513          	addi	a0,a0,-564 # 7480 <malloc+0x146e>
    ...
    36d0:	dd450513          	addi	a0,a0,-556 # 74a0 <malloc+0x148e>
    ...
    36e8:	ecc58593          	addi	a1,a1,-308 # 75b0 <malloc+0x159e>
    ...
    3702:	d8250513          	addi	a0,a0,-638 # 7480 <malloc+0x146e>
    ...
    3716:	de650513          	addi	a0,a0,-538 # 74f8 <malloc+0x14e6>
    ...
    372e:	df650513          	addi	a0,a0,-522 # 7520 <malloc+0x150e>
    ...
    3746:	e0e58593          	addi	a1,a1,-498 # 7550 <malloc+0x153e>
    ...
    3762:	dfa50513          	addi	a0,a0,-518 # 7558 <malloc+0x1546>
    ...
    37aa:	e0258593          	addi	a1,a1,-510 # 75a8 <malloc+0x1596>
    37ae:	00004517          	auipc	a0,0x4
    37b2:	d7250513          	addi	a0,a0,-654 # 7520 <malloc+0x150e>
    ...
    37c6:	d5e50513          	addi	a0,a0,-674 # 7520 <malloc+0x150e>
    ...
    37dc:	d4850513          	addi	a0,a0,-696 # 7520 <malloc+0x150e>
    ...
    37f0:	c9450513          	addi	a0,a0,-876 # 7480 <malloc+0x146e>
    ...
    3804:	e4050513          	addi	a0,a0,-448 # 7640 <malloc+0x162e>
    ...
    3818:	e5c50513          	addi	a0,a0,-420 # 7670 <malloc+0x165e>
    ...
    382c:	e7850513          	addi	a0,a0,-392 # 76a0 <malloc+0x168e>
    ...
    3842:	d6a50513          	addi	a0,a0,-662 # 75a8 <malloc+0x1596>
    ...
    387c:	ca850513          	addi	a0,a0,-856 # 7520 <malloc+0x150e>
    ...
    3894:	ea050513          	addi	a0,a0,-352 # 7730 <malloc+0x171e>
    ...
    38ac:	eb850513          	addi	a0,a0,-328 # 7760 <malloc+0x174e>
    ...
    38c4:	bc050513          	addi	a0,a0,-1088 # 7480 <malloc+0x146e>
    ...
    38da:	baa50513          	addi	a0,a0,-1110 # 7480 <malloc+0x146e>
    ...
    38f0:	b9450513          	addi	a0,a0,-1132 # 7480 <malloc+0x146e>
    ...
    3904:	ef058593          	addi	a1,a1,-272 # 77f0 <malloc+0x17de>
    3908:	00004517          	auipc	a0,0x4
    390c:	e2850513          	addi	a0,a0,-472 # 7730 <malloc+0x171e>
    ...
    3920:	ed458593          	addi	a1,a1,-300 # 77f0 <malloc+0x17de>
    3924:	00004517          	auipc	a0,0x4
    3928:	e3c50513          	addi	a0,a0,-452 # 7760 <malloc+0x174e>
    ...
    393c:	c7058593          	addi	a1,a1,-912 # 75a8 <malloc+0x1596>
    3940:	00004517          	auipc	a0,0x4
    3944:	b6050513          	addi	a0,a0,-1184 # 74a0 <malloc+0x148e>
    ...
    3958:	ddc50513          	addi	a0,a0,-548 # 7730 <malloc+0x171e>
    ...
    396c:	df850513          	addi	a0,a0,-520 # 7760 <malloc+0x174e>
    ...
    3980:	c2c50513          	addi	a0,a0,-980 # 75a8 <malloc+0x1596>
    ...
    3994:	dd050513          	addi	a0,a0,-560 # 7760 <malloc+0x174e>
    ...
    39a8:	d8c50513          	addi	a0,a0,-628 # 7730 <malloc+0x171e>
    ...
    39bc:	ae850513          	addi	a0,a0,-1304 # 74a0 <malloc+0x148e>
    ...
    39d0:	f7450513          	addi	a0,a0,-140 # 7940 <malloc+0x192e>
    ...
    39e4:	bc850513          	addi	a0,a0,-1080 # 75a8 <malloc+0x1596>
    ...
    39f8:	aac50513          	addi	a0,a0,-1364 # 74a0 <malloc+0x148e>
    ...
    3a0c:	a7850513          	addi	a0,a0,-1416 # 7480 <malloc+0x146e>
    ...
    3a20:	f9450513          	addi	a0,a0,-108 # 79b0 <malloc+0x199e>
    ...
    3a34:	a5050513          	addi	a0,a0,-1456 # 7480 <malloc+0x146e>
    ...
    3a56:	a3650513          	addi	a0,a0,-1482 # 7488 <malloc+0x1476>
    ...
    3a72:	a3a50513          	addi	a0,a0,-1478 # 74a8 <malloc+0x1496>
    ...
    3a8e:	a3e50513          	addi	a0,a0,-1474 # 74c8 <malloc+0x14b6>
    ...
    3aaa:	a5a50513          	addi	a0,a0,-1446 # 7500 <malloc+0x14ee>
    ...
    3ac6:	a6e50513          	addi	a0,a0,-1426 # 7530 <malloc+0x151e>
    ...
    3ae2:	a8a50513          	addi	a0,a0,-1398 # 7568 <malloc+0x1556>
    ...
    3afe:	a8e50513          	addi	a0,a0,-1394 # 7588 <malloc+0x1576>
    ...
    3b1a:	aa250513          	addi	a0,a0,-1374 # 75b8 <malloc+0x15a6>
    ...
    3b36:	aae50513          	addi	a0,a0,-1362 # 75e0 <malloc+0x15ce>
    ...
    3b52:	ab250513          	addi	a0,a0,-1358 # 7600 <malloc+0x15ee>
    ...
    3b6e:	abe50513          	addi	a0,a0,-1346 # 7628 <malloc+0x1616>
    ...
    3b8a:	aca50513          	addi	a0,a0,-1334 # 7650 <malloc+0x163e>
    ...
    3ba6:	ade50513          	addi	a0,a0,-1314 # 7680 <malloc+0x166e>
    ...
    3bc2:	aea50513          	addi	a0,a0,-1302 # 76a8 <malloc+0x1696>
    ...
    3bde:	ae650513          	addi	a0,a0,-1306 # 76c0 <malloc+0x16ae>
    ...
    3bfa:	aea50513          	addi	a0,a0,-1302 # 76e0 <malloc+0x16ce>
    ...
    3c16:	aee50513          	addi	a0,a0,-1298 # 7700 <malloc+0x16ee>
    ...
    3c32:	b1250513          	addi	a0,a0,-1262 # 7740 <malloc+0x172e>
    ...
    3c4e:	b2650513          	addi	a0,a0,-1242 # 7770 <malloc+0x175e>
    ...
    3c6a:	b2a50513          	addi	a0,a0,-1238 # 7790 <malloc+0x177e>
    ...
    3c86:	b2e50513          	addi	a0,a0,-1234 # 77b0 <malloc+0x179e>
    ...
    3ca2:	b3250513          	addi	a0,a0,-1230 # 77d0 <malloc+0x17be>
    ...
    3cbe:	b4650513          	addi	a0,a0,-1210 # 7800 <malloc+0x17ee>
    ...
    3cda:	b5250513          	addi	a0,a0,-1198 # 7828 <malloc+0x1816>
    ...
    3cf6:	b5e50513          	addi	a0,a0,-1186 # 7850 <malloc+0x183e>
    ...
    3d12:	b6a50513          	addi	a0,a0,-1174 # 7878 <malloc+0x1866>
    ...
    3d2e:	b6e50513          	addi	a0,a0,-1170 # 7898 <malloc+0x1886>
    ...
    3d4a:	b7250513          	addi	a0,a0,-1166 # 78b8 <malloc+0x18a6>
    ...
    3d66:	b7e50513          	addi	a0,a0,-1154 # 78e0 <malloc+0x18ce>
    ...
    3d82:	b8250513          	addi	a0,a0,-1150 # 7900 <malloc+0x18ee>
    ...
    3d9e:	b8650513          	addi	a0,a0,-1146 # 7920 <malloc+0x190e>
    ...
    3dba:	b9250513          	addi	a0,a0,-1134 # 7948 <malloc+0x1936>
    ...
    3dd6:	80e50513          	addi	a0,a0,-2034 # 75e0 <malloc+0x15ce>
    ...
    3df2:	b7a50513          	addi	a0,a0,-1158 # 7968 <malloc+0x1956>
    ...
    3e0e:	b7e50513          	addi	a0,a0,-1154 # 7988 <malloc+0x1976>
    ...
    3e2a:	b9250513          	addi	a0,a0,-1134 # 79b8 <malloc+0x19a6>
    ...
    3e46:	b9650513          	addi	a0,a0,-1130 # 79d8 <malloc+0x19c6>
...
0000000000003e5c <rmdot>:
{
    ...
    3e6c:	b8850513          	addi	a0,a0,-1144 # 79f0 <malloc+0x19de>
    ...
    3e7e:	b7650513          	addi	a0,a0,-1162 # 79f0 <malloc+0x19de>
    ...
    3e90:	99450513          	addi	a0,a0,-1644 # 6820 <malloc+0x80e>
    ...
    3ea2:	5aa50513          	addi	a0,a0,1450 # 7448 <malloc+0x1436>
    ...
    3eb4:	54050513          	addi	a0,a0,1344 # 73f0 <malloc+0x13de>
    ...
    3ec6:	b9650513          	addi	a0,a0,-1130 # 7a58 <malloc+0x1a46>
    ...
    3ed8:	bac50513          	addi	a0,a0,-1108 # 7a80 <malloc+0x1a6e>
    ...
    3eea:	b0a50513          	addi	a0,a0,-1270 # 79f0 <malloc+0x19de>
    ...
    3f08:	af450513          	addi	a0,a0,-1292 # 79f8 <malloc+0x19e6>
    ...
    3f24:	af050513          	addi	a0,a0,-1296 # 7a10 <malloc+0x19fe>
    ...
    3f40:	aec50513          	addi	a0,a0,-1300 # 7a28 <malloc+0x1a16>
    ...
    3f5c:	ae850513          	addi	a0,a0,-1304 # 7a40 <malloc+0x1a2e>
    ...
    3f78:	48450513          	addi	a0,a0,1156 # 73f8 <malloc+0x13e6>
    ...
    3f94:	ad050513          	addi	a0,a0,-1328 # 7a60 <malloc+0x1a4e>
    ...
    3fb0:	adc50513          	addi	a0,a0,-1316 # 7a88 <malloc+0x1a76>
    ...
    3fcc:	ae050513          	addi	a0,a0,-1312 # 7aa8 <malloc+0x1a96>
...
0000000000003fe2 <dirfile>:
{
    ...
    3ff8:	ad450513          	addi	a0,a0,-1324 # 7ac8 <malloc+0x1ab6>
    ...
    4014:	ab850513          	addi	a0,a0,-1352 # 7ac8 <malloc+0x1ab6>
    ...
    4028:	aec50513          	addi	a0,a0,-1300 # 7b10 <malloc+0x1afe>
    ...
    4040:	ad450513          	addi	a0,a0,-1324 # 7b10 <malloc+0x1afe>
    ...
    4054:	ac050513          	addi	a0,a0,-1344 # 7b10 <malloc+0x1afe>
    ...
    4068:	aac50513          	addi	a0,a0,-1364 # 7b10 <malloc+0x1afe>
    ...
    407c:	a9858593          	addi	a1,a1,-1384 # 7b10 <malloc+0x1afe>
    4080:	00002517          	auipc	a0,0x2
    4084:	29050513          	addi	a0,a0,656 # 6310 <malloc+0x2fe>
    ...
    4098:	a3450513          	addi	a0,a0,-1484 # 7ac8 <malloc+0x1ab6>
    ...
    40ae:	77650513          	addi	a0,a0,1910 # 6820 <malloc+0x80e>
    ...
    40c4:	76050513          	addi	a0,a0,1888 # 6820 <malloc+0x80e>
    ...
    40d8:	0d458593          	addi	a1,a1,212 # 61a8 <malloc+0x196>
    ...
    4104:	9d050513          	addi	a0,a0,-1584 # 7ad0 <malloc+0x1abe>
    ...
    4120:	9d450513          	addi	a0,a0,-1580 # 7af0 <malloc+0x1ade>
    ...
    413c:	9e850513          	addi	a0,a0,-1560 # 7b20 <malloc+0x1b0e>
    ...
    4158:	9cc50513          	addi	a0,a0,-1588 # 7b20 <malloc+0x1b0e>
    ...
    4174:	9d850513          	addi	a0,a0,-1576 # 7b48 <malloc+0x1b36>
    ...
    4190:	9e450513          	addi	a0,a0,-1564 # 7b70 <malloc+0x1b5e>
    ...
    41ac:	9f050513          	addi	a0,a0,-1552 # 7b98 <malloc+0x1b86>
    ...
    41c8:	9fc50513          	addi	a0,a0,-1540 # 7bc0 <malloc+0x1bae>
    ...
    41e4:	a0050513          	addi	a0,a0,-1536 # 7be0 <malloc+0x1bce>
    ...
    4200:	a0c50513          	addi	a0,a0,-1524 # 7c08 <malloc+0x1bf6>
...
0000000000004216 <iref>:
{
    ...
    4234:	9f0a0a13          	addi	s4,s4,-1552 # 7c20 <malloc+0x1c0e>
        mkdir("");
    4238:	00003497          	auipc	s1,0x3
    423c:	4f048493          	addi	s1,s1,1264 # 7728 <malloc+0x1716>
        link("README", "");
    4240:	00002a97          	auipc	s5,0x2
    4244:	0d0a8a93          	addi	s5,s5,208 # 6310 <malloc+0x2fe>
        fd = open("xx", O_CREATE);
    4248:	00004997          	auipc	s3,0x4
    424c:	8d098993          	addi	s3,s3,-1840 # 7b18 <malloc+0x1b06>
    4250:	a891                	j	42a4 <iref+0x8e>
            printf("%s: mkdir irefd failed\n", s);
    4252:	85da                	mv	a1,s6
    4254:	00004517          	auipc	a0,0x4
    4258:	9d450513          	addi	a0,a0,-1580 # 7c28 <malloc+0x1c16>
    ...
    4274:	9d050513          	addi	a0,a0,-1584 # 7c40 <malloc+0x1c2e>
    ...
    4308:	14498993          	addi	s3,s3,324 # 7448 <malloc+0x1436>
        unlink("irefd");
    430c:	00004917          	auipc	s2,0x4
    4310:	91490913          	addi	s2,s2,-1772 # 7c20 <malloc+0x1c0e>
        chdir("..");
    4314:	854e                	mv	a0,s3
    ...
    4330:	0c450513          	addi	a0,a0,196 # 73f0 <malloc+0x13de>
...
0000000000004350 <openiputtest>:
{
    ...
    4360:	8fc50513          	addi	a0,a0,-1796 # 7c58 <malloc+0x1c46>
    ...
    4384:	8d850513          	addi	a0,a0,-1832 # 7c58 <malloc+0x1c46>
    ...
    439a:	8e250513          	addi	a0,a0,-1822 # 7c78 <malloc+0x1c66>
    ...
    43b6:	8ae50513          	addi	a0,a0,-1874 # 7c60 <malloc+0x1c4e>
    ...
    43d2:	5f250513          	addi	a0,a0,1522 # 69c0 <malloc+0x9ae>
    ...
    4400:	85c50513          	addi	a0,a0,-1956 # 7c58 <malloc+0x1c46>
    ...
    4414:	7a050513          	addi	a0,a0,1952 # 6bb0 <malloc+0xb9e>
...
0000000000004442 <forkforkfork>:
{
    ...
    4452:	85250513          	addi	a0,a0,-1966 # 7ca0 <malloc+0x1c8e>
    ...
    447e:	82650513          	addi	a0,a0,-2010 # 7ca0 <malloc+0x1c8e>
    ...
    44b6:	6ce50513          	addi	a0,a0,1742 # 6b80 <malloc+0xb6e>
    ...
    44d0:	7d448493          	addi	s1,s1,2004 # 7ca0 <malloc+0x1c8e>
    44d4:	4581                	li	a1,0
    44d6:	8526                	mv	a0,s1
...
0000000000004512 <killstatus>:
{
    ...
    4578:	44c50513          	addi	a0,a0,1100 # 69c0 <malloc+0x9ae>
    ...
    459e:	71650513          	addi	a0,a0,1814 # 7cb0 <malloc+0x1c9e>
...
00000000000045b4 <preempt>:
{
    ...
    45de:	5a650513          	addi	a0,a0,1446 # 6b80 <malloc+0xb6e>
    ...
    460c:	3b850513          	addi	a0,a0,952 # 69c0 <malloc+0x9ae>
    ...
    4650:	b5c58593          	addi	a1,a1,-1188 # 61a8 <malloc+0x196>
    ...
    467a:	34a50513          	addi	a0,a0,842 # 69c0 <malloc+0x9ae>
    ...
    4696:	63e50513          	addi	a0,a0,1598 # 7cd0 <malloc+0x1cbe>
    ...
    46d2:	61a50513          	addi	a0,a0,1562 # 7ce8 <malloc+0x1cd6>
    ...
    46fe:	60650513          	addi	a0,a0,1542 # 7d00 <malloc+0x1cee>
    ...
    472c:	5e850513          	addi	a0,a0,1512 # 7d10 <malloc+0x1cfe>
...
0000000000004758 <reparent>:
{
    ...
    47ac:	21850513          	addi	a0,a0,536 # 69c0 <malloc+0x9ae>
    ...
    47c8:	38450513          	addi	a0,a0,900 # 6b48 <malloc+0xb36>
...
0000000000004808 <sbrkfail>:
{
    ...
    483e:	28e50513          	addi	a0,a0,654 # 6ac8 <malloc+0xab6>
    ...
    4872:	93a58593          	addi	a1,a1,-1734 # 61a8 <malloc+0x196>
    ...
    4936:	3ee50513          	addi	a0,a0,1006 # 7d20 <malloc+0x1d0e>
    ...
    4952:	07250513          	addi	a0,a0,114 # 69c0 <malloc+0x9ae>
    ...
    499e:	3a650513          	addi	a0,a0,934 # 7d40 <malloc+0x1d2e>
...
00000000000049be <mem>:
{
    ...
    4a42:	33250513          	addi	a0,a0,818 # 7d70 <malloc+0x1d5e>
...
0000000000004a62 <sharedfd>:
{
    ...
    4af8:	2ac50513          	addi	a0,a0,684 # 7da0 <malloc+0x1d8e>
    ...
    4b14:	2b850513          	addi	a0,a0,696 # 7dc8 <malloc+0x1db6>
    ...
    4b58:	23c50513          	addi	a0,a0,572 # 7d90 <malloc+0x1d7e>
    ...
    4b98:	25450513          	addi	a0,a0,596 # 7de8 <malloc+0x1dd6>
    ...
    4bd4:	1c050513          	addi	a0,a0,448 # 7d90 <malloc+0x1d7e>
    ...
    4bfa:	21a50513          	addi	a0,a0,538 # 7e10 <malloc+0x1dfe>
...
0000000000004c1a <fourfiles>:
{
    ...
    4c40:	1ec78793          	addi	a5,a5,492 # 7e28 <malloc+0x1e16>
    4c44:	f6f43823          	sd	a5,-144(s0)
    4c48:	00003797          	auipc	a5,0x3
    4c4c:	1e878793          	addi	a5,a5,488 # 7e30 <malloc+0x1e1e>
    4c50:	f6f43c23          	sd	a5,-136(s0)
    4c54:	00003797          	auipc	a5,0x3
    4c58:	1e478793          	addi	a5,a5,484 # 7e38 <malloc+0x1e26>
    4c5c:	f8f43023          	sd	a5,-128(s0)
    4c60:	00003797          	auipc	a5,0x3
    4c64:	1e078793          	addi	a5,a5,480 # 7e40 <malloc+0x1e2e>
    ...
    4cdc:	0f050513          	addi	a0,a0,240 # 6dc8 <malloc+0xdb6>
    ...
    4d58:	0f450513          	addi	a0,a0,244 # 7e48 <malloc+0x1e36>
    ...
    4d72:	0ea50513          	addi	a0,a0,234 # 7e58 <malloc+0x1e46>
    ...
    4d9a:	0da50513          	addi	a0,a0,218 # 7e70 <malloc+0x1e5e>
    ...
    4e28:	05c50513          	addi	a0,a0,92 # 7e80 <malloc+0x1e6e>
...
0000000000004e5c <concreate>:
{
    ...
    4e8a:	012b8b93          	addi	s7,s7,18 # 7e98 <malloc+0x1e86>
    for (i = 0; i < N; i++)
    ...
    4ecc:	fd850513          	addi	a0,a0,-40 # 7ea0 <malloc+0x1e8e>
    ...
    4eea:	fb250513          	addi	a0,a0,-78 # 7e98 <malloc+0x1e86>
    ...
    4f22:	90250513          	addi	a0,a0,-1790 # 6820 <malloc+0x80e>
    ...
    4f9a:	f2a50513          	addi	a0,a0,-214 # 7ec0 <malloc+0x1eae>
    ...
    4fba:	f2a50513          	addi	a0,a0,-214 # 7ee0 <malloc+0x1ece>
    ...
    4ff2:	f1a50513          	addi	a0,a0,-230 # 7f08 <malloc+0x1ef6>
    ...
    500e:	9b650513          	addi	a0,a0,-1610 # 69c0 <malloc+0x9ae>
...
00000000000051b8 <bigfile>:
{
    ...
    5240:	d0450513          	addi	a0,a0,-764 # 7f40 <malloc+0x1f2e>
    ...
    52a4:	cb050513          	addi	a0,a0,-848 # 7f50 <malloc+0x1f3e>
    ...
    52c0:	cb450513          	addi	a0,a0,-844 # 7f70 <malloc+0x1f5e>
    ...
    52dc:	cb850513          	addi	a0,a0,-840 # 7f90 <malloc+0x1f7e>
    ...
    52f8:	cbc50513          	addi	a0,a0,-836 # 7fb0 <malloc+0x1f9e>
    ...
    5314:	cc050513          	addi	a0,a0,-832 # 7fd0 <malloc+0x1fbe>
    ...
    5330:	cbc50513          	addi	a0,a0,-836 # 7fe8 <malloc+0x1fd6>
    ...
    535e:	be650513          	addi	a0,a0,-1050 # 7f40 <malloc+0x1f2e>
    ...
    5382:	c8a50513          	addi	a0,a0,-886 # 8008 <malloc+0x1ff6>
...
0000000000005398 <fsfull>:
{
    ...
    53ba:	c7250513          	addi	a0,a0,-910 # 8028 <malloc+0x2016>
    ...
    53da:	c62c8c93          	addi	s9,s9,-926 # 8038 <malloc+0x2026>
        int total = 0;
    53de:	4d81                	li	s11,0
    ...
    5454:	bf850513          	addi	a0,a0,-1032 # 8048 <malloc+0x2036>
    ...
    54ca:	ba250513          	addi	a0,a0,-1118 # 8068 <malloc+0x2056>
    ...
    551a:	b4250513          	addi	a0,a0,-1214 # 8058 <malloc+0x2046>
...
int run(void f(char *), char *s)
{
    ...
    554c:	b3850513          	addi	a0,a0,-1224 # 8080 <malloc+0x206e>
    ...
    557c:	b3050513          	addi	a0,a0,-1232 # 80a8 <malloc+0x2096>
    ...
    55a0:	af450513          	addi	a0,a0,-1292 # 8090 <malloc+0x207e>
    ...
    55c8:	aec50513          	addi	a0,a0,-1300 # 80b0 <malloc+0x209e>
...
int runtests(struct test *tests, char *justone)
{
    ...
    5618:	aa450513          	addi	a0,a0,-1372 # 80b8 <malloc+0x20a6>
...
int countfree()
{
    ...
    5672:	b3a98993          	addi	s3,s3,-1222 # 61a8 <malloc+0x196>
            uint64 a = (uint64)sbrk(4096);
    ...
    56a4:	a7050513          	addi	a0,a0,-1424 # 8110 <malloc+0x20fe>
    ...
    56be:	a1650513          	addi	a0,a0,-1514 # 80d0 <malloc+0x20be>
    ...
    56d8:	a1c50513          	addi	a0,a0,-1508 # 80f0 <malloc+0x20de>
    ...
    5726:	a0e50513          	addi	a0,a0,-1522 # 8130 <malloc+0x211e>
...
int drivetests(int quick, int continuous, char *justone)
{
    ...
    5788:	9ccb8b93          	addi	s7,s7,-1588 # 8150 <malloc+0x213e>
        int free0 = countfree();
        int free1 = 0;
...
int main(int argc, char *argv[])
{
    ...
    589e:	91e58593          	addi	a1,a1,-1762 # 81b8 <malloc+0x21a6>
    ...
    58b6:	95e58593          	addi	a1,a1,-1698 # 8210 <malloc+0x21fe>
    ...
    58cc:	94058593          	addi	a1,a1,-1728 # 8208 <malloc+0x21f6>
    ...
    58f8:	8cc50513          	addi	a0,a0,-1844 # 81c0 <malloc+0x21ae>
    ...
    5924:	8d050513          	addi	a0,a0,-1840 # 81f0 <malloc+0x21de>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    5cc8:	91450513          	addi	a0,a0,-1772 # 85d8 <digits>
    5ccc:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
    ...
    5d82:	4c55                	li	s8,21
    5d84:	00002c97          	auipc	s9,0x2
    5d88:	7fcc8c93          	addi	s9,s9,2044 # 8580 <malloc+0x256e>
  ...
  putc(fd, 'x');
    ...
    5d96:	846b8b93          	addi	s7,s7,-1978 # 85d8 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    5eb6:	bde5                	j	5dae <vprintf+0x60>
          s = "(null)";
    5eb8:	00002997          	auipc	s3,0x2
    5ebc:	6c098993          	addi	s3,s3,1728 # 8578 <malloc+0x2566>
        while(*s != 0){
    5ec0:	85ee                	mv	a1,s11
