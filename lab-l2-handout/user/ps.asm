...
int main(int argc, char *argv[])
{
  ...
  14:	84098993          	addi	s3,s3,-1984 # 850 <malloc+0xf8>
  18:	a815                	j	4c <main+0x4c>
            printf("SYSCALL FAILED");
  1a:	00001517          	auipc	a0,0x1
  1e:	82650513          	addi	a0,a0,-2010 # 840 <malloc+0xe8>
  22:	00000097          	auipc	ra,0x0
  26:	67e080e7          	jalr	1662(ra) # 6a0 <printf>
            exit(-1);
  2a:	557d                	li	a0,-1
  ...
  40:	664080e7          	jalr	1636(ra) # 6a0 <printf>
        }
        proc_idx += 2;
  ...
  6e:	636080e7          	jalr	1590(ra) # 6a0 <printf>
            if (procs[i].state == UNUSED)
  72:	50d4                	lw	a3,36(s1)
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 40e:	4b650513          	addi	a0,a0,1206 # 8c0 <digits>
 412:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4ce:	39ec8c93          	addi	s9,s9,926 # 868 <malloc+0x110>
 ...
 4dc:	3e8b8b93          	addi	s7,s7,1000 # 8c0 <digits>
 ...
 602:	26298993          	addi	s3,s3,610 # 860 <malloc+0x108>
        while(*s != 0){
 606:	85ee                	mv	a1,s11
