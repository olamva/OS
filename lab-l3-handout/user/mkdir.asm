...
main(int argc, char *argv[])
{
  ...
  74:	296080e7          	jalr	662(ra) # 306 <exit>
...
_main()
{
  ...
  8e:	27c080e7          	jalr	636(ra) # 306 <exit>
...
gets(char *buf, int max)
{
 ...
 180:	1a2080e7          	jalr	418(ra) # 31e <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 1d2:	178080e7          	jalr	376(ra) # 346 <open>
  if(fd < 0)
 ...
 1ee:	144080e7          	jalr	324(ra) # 32e <close>
  return r;
}
 1f2:	854a                	mv	a0,s2
