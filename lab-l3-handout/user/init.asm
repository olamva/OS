...
putc(int fd, char c)
{
 ...
 464:	f46080e7          	jalr	-186(ra) # 3a6 <write>
}
...
malloc(uint nbytes)
{
 ...
 8ba:	b58080e7          	jalr	-1192(ra) # 40e <sbrk>
  if(p == (char*)-1)
