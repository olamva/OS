...
0000000000000264 <bigwrite>:
{
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     34a:	882080e7          	jalr	-1918(ra) # 5bc8 <exit>
...
badwrite(char *s)
{
  ...
  unlink("junk");
     ...
     36a:	8b2080e7          	jalr	-1870(ra) # 5c18 <unlink>
  ...
  for(int i = 0; i < assumed_free; i++){
    ...
    int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     38a:	882080e7          	jalr	-1918(ra) # 5c08 <open>
     38e:	84aa                	mv	s1,a0
    if(fd < 0){
    ...
    write(fd, (char*)0xffffffffffL, 1);
     ...
     39c:	850080e7          	jalr	-1968(ra) # 5be8 <write>
    close(fd);
     3a0:	8526                	mv	a0,s1
     3a2:	00006097          	auipc	ra,0x6
     3a6:	84e080e7          	jalr	-1970(ra) # 5bf0 <close>
    unlink("junk");
     3aa:	854e                	mv	a0,s3
     3ac:	00006097          	auipc	ra,0x6
     3b0:	86c080e7          	jalr	-1940(ra) # 5c18 <unlink>
  for(int i = 0; i < assumed_free; i++){
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     3ca:	842080e7          	jalr	-1982(ra) # 5c08 <open>
     3ce:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  if(write(fd, "x", 1) != 1){
     ...
     3e2:	80a080e7          	jalr	-2038(ra) # 5be8 <write>
     3e6:	4785                	li	a5,1
    ...
    exit(1);
     ...
     402:	7ca080e7          	jalr	1994(ra) # 5bc8 <exit>
      printf("open junk failed\n");
     ...
     41c:	7b0080e7          	jalr	1968(ra) # 5bc8 <exit>
    printf("open junk failed\n");
...
outofinodes(char *s)
{
  ...
  for(int i = 0; i < nzz; i++){
    ...
    close(fd);
     ...
     4ca:	72a080e7          	jalr	1834(ra) # 5bf0 <close>
  for(int i = 0; i < nzz; i++){
  ...
  for(int i = 0; i < nzz; i++){
    ...
    unlink(name);
     ...
     516:	706080e7          	jalr	1798(ra) # 5c18 <unlink>
  for(int i = 0; i < nzz; i++){
...
000000000000052e <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     566:	6a6080e7          	jalr	1702(ra) # 5c08 <open>
     56a:	84aa                	mv	s1,a0
    if(fd < 0){
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     612:	5ba080e7          	jalr	1466(ra) # 5bc8 <exit>
     ...
     630:	59c080e7          	jalr	1436(ra) # 5bc8 <exit>
     ...
     64e:	57e080e7          	jalr	1406(ra) # 5bc8 <exit>
      printf("pipe() failed\n");
     ...
     668:	564080e7          	jalr	1380(ra) # 5bc8 <exit>
     ...
     686:	546080e7          	jalr	1350(ra) # 5bc8 <exit>
...
000000000000068a <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     6ca:	542080e7          	jalr	1346(ra) # 5c08 <open>
     6ce:	84aa                	mv	s1,a0
    if(fd < 0){
    ...
    n = write(fds[1], "x", 1);
     ...
     70a:	4e2080e7          	jalr	1250(ra) # 5be8 <write>
    if(n != 1){
     70e:	4785                	li	a5,1
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     772:	45a080e7          	jalr	1114(ra) # 5bc8 <exit>
     ...
     790:	43c080e7          	jalr	1084(ra) # 5bc8 <exit>
      printf("pipe() failed\n");
     ...
     7aa:	422080e7          	jalr	1058(ra) # 5bc8 <exit>
     ...
     7c4:	408080e7          	jalr	1032(ra) # 5bc8 <exit>
     ...
     7e2:	3ea080e7          	jalr	1002(ra) # 5bc8 <exit>
...
00000000000007e6 <truncate1>:
{
  ...
  unlink("truncfile");
     ...
     806:	416080e7          	jalr	1046(ra) # 5c18 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
     ...
     81a:	3f2080e7          	jalr	1010(ra) # 5c08 <open>
     81e:	84aa                	mv	s1,a0
  write(fd1, "abcd", 4);
     820:	4611                	li	a2,4
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     876:	396080e7          	jalr	918(ra) # 5c08 <open>
     87a:	89aa                	mv	s3,a0
  ...
  n = read(fd2, buf, sizeof(buf));
     ...
     8b2:	332080e7          	jalr	818(ra) # 5be0 <read>
     8b6:	8a2a                	mv	s4,a0
  if(n != 0){
  ...
  n = read(fd2, buf, sizeof(buf));
     ...
     8f4:	2f0080e7          	jalr	752(ra) # 5be0 <read>
  if(n != 2){
     8f8:	4789                	li	a5,2
  ...
  unlink("truncfile");
     ...
     90a:	312080e7          	jalr	786(ra) # 5c18 <unlink>
  close(fd1);
     90e:	854e                	mv	a0,s3
     910:	00005097          	auipc	ra,0x5
     914:	2e0080e7          	jalr	736(ra) # 5bf0 <close>
  close(fd2);
     918:	8526                	mv	a0,s1
     91a:	00005097          	auipc	ra,0x5
     91e:	2d6080e7          	jalr	726(ra) # 5bf0 <close>
  close(fd3);
     922:	854a                	mv	a0,s2
     924:	00005097          	auipc	ra,0x5
     928:	2cc080e7          	jalr	716(ra) # 5bf0 <close>
}
    ...
    exit(1);
     ...
     958:	274080e7          	jalr	628(ra) # 5bc8 <exit>
    printf("aaa fd3=%d\n", fd3);
     95c:	85ca                	mv	a1,s2
    ...
    exit(1);
     ...
     988:	244080e7          	jalr	580(ra) # 5bc8 <exit>
    printf("bbb fd2=%d\n", fd2);
     98c:	85a6                	mv	a1,s1
    ...
    exit(1);
     ...
     9b8:	214080e7          	jalr	532(ra) # 5bc8 <exit>
    ...
    exit(1);
     ...
     9d6:	1f6080e7          	jalr	502(ra) # 5bc8 <exit>
    ...
    exit(1);
     ...
     9f4:	1d8080e7          	jalr	472(ra) # 5bc8 <exit>
...
00000000000009f8 <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     a1e:	1ee080e7          	jalr	494(ra) # 5c08 <open>
  if(fd < 0){
  ...
  for(i = 0; i < N; i++){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     a48:	1a4080e7          	jalr	420(ra) # 5be8 <write>
     a4c:	47a9                	li	a5,10
    ...
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     ...
     a5c:	190080e7          	jalr	400(ra) # 5be8 <write>
     a60:	47a9                	li	a5,10
  ...
  i = read(fd, buf, N*SZ*2);
     ...
     a9e:	146080e7          	jalr	326(ra) # 5be0 <read>
  if(i != N*SZ*2){
  ...
  if(unlink("small") < 0){
    ...
    exit(1);
     ...
     af4:	0d8080e7          	jalr	216(ra) # 5bc8 <exit>
     ...
     b12:	0ba080e7          	jalr	186(ra) # 5bc8 <exit>
     ...
     b30:	09c080e7          	jalr	156(ra) # 5bc8 <exit>
    ...
    exit(1);
     ...
     b4c:	080080e7          	jalr	128(ra) # 5bc8 <exit>
    ...
    exit(1);
     ...
     b68:	064080e7          	jalr	100(ra) # 5bc8 <exit>
    ...
    exit(1);
     ...
     b84:	048080e7          	jalr	72(ra) # 5bc8 <exit>
...
0000000000000b88 <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     bac:	060080e7          	jalr	96(ra) # 5c08 <open>
     bb0:	89aa                	mv	s3,a0
  for(i = 0; i < MAXFILE; i++){
     bb2:	4481                	li	s1,0
    ((int*)buf)[0] = i;
  ...
  if(fd < 0){
    ...
    if(write(fd, buf, BSIZE) != BSIZE){
     ...
     bd4:	018080e7          	jalr	24(ra) # 5be8 <write>
  ...
  if(fd < 0){
    ...
    i = read(fd, buf, BSIZE);
     ...
     c1e:	fc6080e7          	jalr	-58(ra) # 5be0 <read>
    if(i == 0){
    ...
    exit(1);
     ...
     c50:	f7c080e7          	jalr	-132(ra) # 5bc8 <exit>
     ...
     c6e:	f5e080e7          	jalr	-162(ra) # 5bc8 <exit>
    ...
    exit(1);
     ...
     c8a:	f42080e7          	jalr	-190(ra) # 5bc8 <exit>
      if(n == MAXFILE - 1){
  ...
  if(unlink("big") < 0){
     ...
     ce2:	eea080e7          	jalr	-278(ra) # 5bc8 <exit>
     ...
     d00:	ecc080e7          	jalr	-308(ra) # 5bc8 <exit>
     ...
     d1e:	eae080e7          	jalr	-338(ra) # 5bc8 <exit>
    ...
    exit(1);
     ...
     d3a:	e92080e7          	jalr	-366(ra) # 5bc8 <exit>
...
0000000000000d3e <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     d5e:	eae080e7          	jalr	-338(ra) # 5c08 <open>
  if(fd < 0){
  ...
  if(unlink("unlinkread") != 0){
     ...
     da8:	e74080e7          	jalr	-396(ra) # 5c18 <unlink>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     dbe:	e4e080e7          	jalr	-434(ra) # 5c08 <open>
     dc2:	892a                	mv	s2,a0
  write(fd1, "yyy", 3);
     dc4:	460d                	li	a2,3
     ...
     dd2:	e1a080e7          	jalr	-486(ra) # 5be8 <write>
  close(fd1);
     dd6:	854a                	mv	a0,s2
     dd8:	00005097          	auipc	ra,0x5
     ddc:	e18080e7          	jalr	-488(ra) # 5bf0 <close>
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     df0:	df4080e7          	jalr	-524(ra) # 5be0 <read>
     df4:	4795                	li	a5,5
  ...
  unlink("unlinkread");
    ...
    exit(1);
     ...
     e64:	d68080e7          	jalr	-664(ra) # 5bc8 <exit>
    ...
    exit(1);
     ...
     e80:	d4c080e7          	jalr	-692(ra) # 5bc8 <exit>
    ...
    exit(1);
     ...
     e9c:	d30080e7          	jalr	-720(ra) # 5bc8 <exit>
    ...
    exit(1);
     ...
     eb8:	d14080e7          	jalr	-748(ra) # 5bc8 <exit>
    ...
    exit(1);
     ...
     ed4:	cf8080e7          	jalr	-776(ra) # 5bc8 <exit>
    ...
    exit(1);
     ...
     ef0:	cdc080e7          	jalr	-804(ra) # 5bc8 <exit>
...
0000000000000ef4 <linktest>:
{
  ...
  fd = open("lf1", O_CREATE|O_RDWR);
     ...
     f32:	cda080e7          	jalr	-806(ra) # 5c08 <open>
  if(fd < 0){
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     f4a:	ca2080e7          	jalr	-862(ra) # 5be8 <write>
     f4e:	4795                	li	a5,5
     f50:	10f51863          	bne	a0,a5,1060 <linktest+0x16c>
  close(fd);
     f54:	8526                	mv	a0,s1
     f56:	00005097          	auipc	ra,0x5
     f5a:	c9a080e7          	jalr	-870(ra) # 5bf0 <close>
  if(link("lf1", "lf2") < 0){
     ...
     f72:	cba080e7          	jalr	-838(ra) # 5c28 <link>
  ...
  fd = open("lf2", 0);
     ...
     fae:	c5e080e7          	jalr	-930(ra) # 5c08 <open>
     fb2:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  unlink("lf2");
     ...
     ffc:	c20080e7          	jalr	-992(ra) # 5c18 <unlink>
  if(link("lf2", "lf1") >= 0){
    ...
    1014:	c18080e7          	jalr	-1000(ra) # 5c28 <link>
  ...
  if(link(".", "lf1") >= 0){
    ...
    1030:	bfc080e7          	jalr	-1028(ra) # 5c28 <link>
    ...
    105c:	b70080e7          	jalr	-1168(ra) # 5bc8 <exit>
    ...
    1078:	b54080e7          	jalr	-1196(ra) # 5bc8 <exit>
    ...
    1094:	b38080e7          	jalr	-1224(ra) # 5bc8 <exit>
    ...
    10b0:	b1c080e7          	jalr	-1252(ra) # 5bc8 <exit>
    ...
    10cc:	b00080e7          	jalr	-1280(ra) # 5bc8 <exit>
    ...
    10e8:	ae4080e7          	jalr	-1308(ra) # 5bc8 <exit>
    ...
    1104:	ac8080e7          	jalr	-1336(ra) # 5bc8 <exit>
    ...
    1120:	aac080e7          	jalr	-1364(ra) # 5bc8 <exit>
    ...
    113c:	a90080e7          	jalr	-1392(ra) # 5bc8 <exit>
...
0000000000001140 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    1170:	abc080e7          	jalr	-1348(ra) # 5c28 <link>
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    11aa:	a22080e7          	jalr	-1502(ra) # 5bc8 <exit>
...
00000000000011ae <bigdir>:
{
  ...
  unlink("bd");
    ...
    11d0:	a4c080e7          	jalr	-1460(ra) # 5c18 <unlink>
  fd = open("bd", O_CREATE);
    ...
    11e4:	a28080e7          	jalr	-1496(ra) # 5c08 <open>
  if(fd < 0){
    11e8:	0c054963          	bltz	a0,12ba <bigdir+0x10c>
  close(fd);
    11ec:	00005097          	auipc	ra,0x5
    11f0:	a04080e7          	jalr	-1532(ra) # 5bf0 <close>
  for(i = 0; i < N; i++){
    11f4:	4901                	li	s2,0
    name[0] = 'x';
  ...
  for(i = 0; i < N; i++){
    ...
    123e:	9ee080e7          	jalr	-1554(ra) # 5c28 <link>
    1242:	84aa                	mv	s1,a0
  ...
  unlink("bd");
    ...
    1258:	9c4080e7          	jalr	-1596(ra) # 5c18 <unlink>
    name[0] = 'x';
  ...
  for(i = 0; i < N; i++){
    ...
    129a:	982080e7          	jalr	-1662(ra) # 5c18 <unlink>
  ...
  for(i = 0; i < N; i++){
    ...
    12d2:	8fa080e7          	jalr	-1798(ra) # 5bc8 <exit>
    ...
    12f2:	8da080e7          	jalr	-1830(ra) # 5bc8 <exit>
    ...
    130e:	8be080e7          	jalr	-1858(ra) # 5bc8 <exit>
...
0000000000001312 <pgbug>:
{
  ...
  exec(big, argv);
    ...
    1332:	8d2080e7          	jalr	-1838(ra) # 5c00 <exec>
  pipe(big);
    1336:	6088                	ld	a0,0(s1)
    1338:	00005097          	auipc	ra,0x5
    133c:	8a0080e7          	jalr	-1888(ra) # 5bd8 <pipe>
  exit(0);
    1340:	4501                	li	a0,0
    1342:	00005097          	auipc	ra,0x5
    1346:	886080e7          	jalr	-1914(ra) # 5bc8 <exit>
...
000000000000134a <badarg>:
{
    ...
    137e:	886080e7          	jalr	-1914(ra) # 5c00 <exec>
  ...
  exit(0);
    ...
    138c:	840080e7          	jalr	-1984(ra) # 5bc8 <exit>
...
0000000000001390 <copyinstr2>:
{
  ...
  int ret = unlink(b);
    ...
    13ba:	862080e7          	jalr	-1950(ra) # 5c18 <unlink>
  if(ret != -1){
    13be:	57fd                	li	a5,-1
  ...
  int fd = open(b, O_CREATE | O_WRONLY);
    ...
    13d0:	83c080e7          	jalr	-1988(ra) # 5c08 <open>
  if(fd != -1){
    13d4:	57fd                	li	a5,-1
  ...
  ret = link(b, b);
    ...
    13e4:	848080e7          	jalr	-1976(ra) # 5c28 <link>
  if(ret != -1){
    13e8:	57fd                	li	a5,-1
  ...
  ret = exec(b, args);
    ...
    140a:	7fa080e7          	jalr	2042(ra) # 5c00 <exec>
  if(ret != -1){
    140e:	57fd                	li	a5,-1
  ...
  if(pid == 0){
    ...
    147a:	78a080e7          	jalr	1930(ra) # 5c00 <exec>
    if(ret != -1){
    147e:	57fd                	li	a5,-1
    ...
    149c:	730080e7          	jalr	1840(ra) # 5bc8 <exit>
    ...
    14bc:	710080e7          	jalr	1808(ra) # 5bc8 <exit>
    ...
    14dc:	6f0080e7          	jalr	1776(ra) # 5bc8 <exit>
    ...
    14fe:	6ce080e7          	jalr	1742(ra) # 5bc8 <exit>
    ...
    151e:	6ae080e7          	jalr	1710(ra) # 5bc8 <exit>
    printf("fork failed\n");
  ...
  if(st != 747){
    ...
    1582:	64a080e7          	jalr	1610(ra) # 5bc8 <exit>
...
0000000000001586 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    15aa:	662080e7          	jalr	1634(ra) # 5c08 <open>
    15ae:	00004097          	auipc	ra,0x4
    15b2:	642080e7          	jalr	1602(ra) # 5bf0 <close>
  pid = fork();
  ...
  if(pid == 0){
    ...
    15e0:	62c080e7          	jalr	1580(ra) # 5c08 <open>
    15e4:	84aa                	mv	s1,a0
      if(fd < 0){
    ...
    15f2:	5fa080e7          	jalr	1530(ra) # 5be8 <write>
      if(n != 10){
    15f6:	47a9                	li	a5,10
    ...
    1602:	5f2080e7          	jalr	1522(ra) # 5bf0 <close>
      fd = open("truncfile", O_RDONLY);
    1606:	4581                	li	a1,0
    1608:	8552                	mv	a0,s4
    160a:	00004097          	auipc	ra,0x4
    160e:	5fe080e7          	jalr	1534(ra) # 5c08 <open>
    1612:	84aa                	mv	s1,a0
      read(fd, buf, sizeof(buf));
    1614:	02000613          	li	a2,32
    1618:	f9840593          	addi	a1,s0,-104
    161c:	00004097          	auipc	ra,0x4
    1620:	5c4080e7          	jalr	1476(ra) # 5be0 <read>
      close(fd);
    1624:	8526                	mv	a0,s1
    1626:	00004097          	auipc	ra,0x4
    162a:	5ca080e7          	jalr	1482(ra) # 5bf0 <close>
    for(int i = 0; i < 100; i++){
    ...
    163a:	592080e7          	jalr	1426(ra) # 5bc8 <exit>
    ...
    1656:	576080e7          	jalr	1398(ra) # 5bc8 <exit>
    ...
    1672:	55a080e7          	jalr	1370(ra) # 5bc8 <exit>
    ...
    1690:	53c080e7          	jalr	1340(ra) # 5bc8 <exit>
    ...
    16b2:	55a080e7          	jalr	1370(ra) # 5c08 <open>
    16b6:	84aa                	mv	s1,a0
    if(fd < 0){
    ...
    16c4:	528080e7          	jalr	1320(ra) # 5be8 <write>
    if(n != 3){
    16c8:	478d                	li	a5,3
    ...
    16d4:	520080e7          	jalr	1312(ra) # 5bf0 <close>
  for(int i = 0; i < 150; i++){
  ...
  exit(xstatus);
    ...
    171e:	4ae080e7          	jalr	1198(ra) # 5bc8 <exit>
    ...
    173c:	490080e7          	jalr	1168(ra) # 5bc8 <exit>
...
0000000000001740 <exectest>:
{
  ...
  unlink("echo-ok");
    ...
    1776:	4a6080e7          	jalr	1190(ra) # 5c18 <unlink>
  pid = fork();
  ...
  if(pid == 0) {
    ...
    1790:	464080e7          	jalr	1124(ra) # 5bf0 <close>
    ...
    17a4:	468080e7          	jalr	1128(ra) # 5c08 <open>
    if(fd < 0) {
    ...
    17ca:	402080e7          	jalr	1026(ra) # 5bc8 <exit>
     printf("%s: fork failed\n", s);
    17ce:	85ca                	mv	a1,s2
    ...
    17e6:	3e6080e7          	jalr	998(ra) # 5bc8 <exit>
    ...
    1802:	3ca080e7          	jalr	970(ra) # 5bc8 <exit>
  ...
  if(xstatus != 0)
    ...
    1838:	394080e7          	jalr	916(ra) # 5bc8 <exit>
    ...
    1854:	378080e7          	jalr	888(ra) # 5bc8 <exit>
  ...
  fd = open("echo-ok", O_RDONLY);
    ...
    187a:	392080e7          	jalr	914(ra) # 5c08 <open>
  if(fd < 0) {
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    188c:	358080e7          	jalr	856(ra) # 5be0 <read>
    1890:	4789                	li	a5,2
    ...
    18ae:	31e080e7          	jalr	798(ra) # 5bc8 <exit>
    printf("%s: open failed\n", s);
    18b2:	85ca                	mv	a1,s2
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    190e:	2be080e7          	jalr	702(ra) # 5bc8 <exit>
    exit(0);
    1912:	4501                	li	a0,0
    1914:	00004097          	auipc	ra,0x4
    1918:	2b4080e7          	jalr	692(ra) # 5bc8 <exit>
...
000000000000191c <pipe1>:
{
  ...
  if(pipe(fds) != 0){
    ...
    193c:	2a0080e7          	jalr	672(ra) # 5bd8 <pipe>
  ...
  if(pid == 0){
    ...
    195c:	298080e7          	jalr	664(ra) # 5bf0 <close>
    total = 0;
    1960:	8a26                	mv	s4,s1
    cc = 1;
    1962:	4985                	li	s3,1
    ...
    197a:	26a080e7          	jalr	618(ra) # 5be0 <read>
    ...
    19ce:	1fe080e7          	jalr	510(ra) # 5bc8 <exit>
    close(fds[0]);
    19d2:	fa842503          	lw	a0,-88(s0)
    19d6:	00004097          	auipc	ra,0x4
    19da:	21a080e7          	jalr	538(ra) # 5bf0 <close>
    for(n = 0; n < N; n++){
    ...
    19f6:	42da8a93          	addi	s5,s5,1069 # 142d <copyinstr2+0x9d>
{
    ...
    1a1c:	1d0080e7          	jalr	464(ra) # 5be8 <write>
    ...
    1a38:	194080e7          	jalr	404(ra) # 5bc8 <exit>
    ...
    1a54:	178080e7          	jalr	376(ra) # 5bc8 <exit>
    ...
    1ae2:	0ea080e7          	jalr	234(ra) # 5bc8 <exit>
...
0000000000001ae6 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1b16:	0be080e7          	jalr	190(ra) # 5bd0 <wait>
  ...
  for(i = 0; i < 100; i++){
    ...
    1b54:	078080e7          	jalr	120(ra) # 5bc8 <exit>
    ...
    1b70:	05c080e7          	jalr	92(ra) # 5bc8 <exit>
    ...
    1b8c:	040080e7          	jalr	64(ra) # 5bc8 <exit>
      exit(i);
    1b90:	854a                	mv	a0,s2
    1b92:	00004097          	auipc	ra,0x4
    1b96:	036080e7          	jalr	54(ra) # 5bc8 <exit>
...
0000000000001b9a <twochildren>:
{
    ...
    1bce:	006080e7          	jalr	6(ra) # 5bd0 <wait>
        wait(0);
    1bd2:	4501                	li	a0,0
    1bd4:	00004097          	auipc	ra,0x4
    1bd8:	ffc080e7          	jalr	-4(ra) # 5bd0 <wait>
  for(int i = 0; i < 1000; i++){
    ...
    1c04:	fc8080e7          	jalr	-56(ra) # 5bc8 <exit>
      exit(0);
    1c08:	00004097          	auipc	ra,0x4
    1c0c:	fc0080e7          	jalr	-64(ra) # 5bc8 <exit>
        printf("%s: fork failed\n", s);
    1c10:	85ca                	mv	a1,s2
    ...
    1c28:	fa4080e7          	jalr	-92(ra) # 5bc8 <exit>
        exit(0);
    1c2c:	00004097          	auipc	ra,0x4
    1c30:	f9c080e7          	jalr	-100(ra) # 5bc8 <exit>
...
0000000000001c34 <forkfork>:
{
    ...
    1c64:	f70080e7          	jalr	-144(ra) # 5bd0 <wait>
    if(xstatus != 0) {
    ...
    1c76:	f5e080e7          	jalr	-162(ra) # 5bd0 <wait>
    if(xstatus != 0) {
    ...
    1ca2:	f2a080e7          	jalr	-214(ra) # 5bc8 <exit>
{
    ...
    1cbe:	f16080e7          	jalr	-234(ra) # 5bd0 <wait>
      for(int j = 0; j < 200; j++){
    ...
    1ccc:	f00080e7          	jalr	-256(ra) # 5bc8 <exit>
          exit(1);
    1cd0:	4505                	li	a0,1
    1cd2:	00004097          	auipc	ra,0x4
    1cd6:	ef6080e7          	jalr	-266(ra) # 5bc8 <exit>
          exit(0);
    1cda:	00004097          	auipc	ra,0x4
    1cde:	eee080e7          	jalr	-274(ra) # 5bc8 <exit>
    ...
    1cfa:	ed2080e7          	jalr	-302(ra) # 5bc8 <exit>
...
0000000000001cfe <reparent2>:
{
    ...
    1d20:	eb4080e7          	jalr	-332(ra) # 5bd0 <wait>
  for(int i = 0; i < 800; i++){
  ...
  exit(0);
    ...
    1d2e:	e9e080e7          	jalr	-354(ra) # 5bc8 <exit>
      printf("fork failed\n");
    ...
    1d48:	e84080e7          	jalr	-380(ra) # 5bc8 <exit>
      fork();
    ...
    1d62:	e6a080e7          	jalr	-406(ra) # 5bc8 <exit>
...
0000000000001d66 <createdelete>:
{
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    1da6:	e2e080e7          	jalr	-466(ra) # 5bd0 <wait>
    if(xstatus != 0)
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1de6:	de6080e7          	jalr	-538(ra) # 5bc8 <exit>
      name[0] = 'p' + pi;
    ...
    1e12:	dba080e7          	jalr	-582(ra) # 5bc8 <exit>
      for(i = 0; i < N; i++){
    ...
    1e30:	ddc080e7          	jalr	-548(ra) # 5c08 <open>
        if(fd < 0){
    1e34:	fc0543e3          	bltz	a0,1dfa <createdelete+0x94>
        close(fd);
    1e38:	00004097          	auipc	ra,0x4
    1e3c:	db8080e7          	jalr	-584(ra) # 5bf0 <close>
        if(i > 0 && (i % 2 ) == 0){
    ...
    1e64:	db8080e7          	jalr	-584(ra) # 5c18 <unlink>
    ...
    1e84:	d48080e7          	jalr	-696(ra) # 5bc8 <exit>
      exit(0);
    1e88:	4501                	li	a0,0
    1e8a:	00004097          	auipc	ra,0x4
    1e8e:	d3e080e7          	jalr	-706(ra) # 5bc8 <exit>
      exit(1);
    1e92:	4505                	li	a0,1
    1e94:	00004097          	auipc	ra,0x4
    1e98:	d34080e7          	jalr	-716(ra) # 5bc8 <exit>
    ...
    1eb8:	d14080e7          	jalr	-748(ra) # 5bc8 <exit>
      } else if((i >= 1 && i < N/2) && fd >= 0){
    ...
    1ee0:	d2c080e7          	jalr	-724(ra) # 5c08 <open>
      if((i == 0 || i >= N/2) && fd < 0){
    ...
    1ef8:	cfc080e7          	jalr	-772(ra) # 5bf0 <close>
    ...
    1f1e:	cae080e7          	jalr	-850(ra) # 5bc8 <exit>
  for(i = 0; i < N; i++){
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1f58:	cc4080e7          	jalr	-828(ra) # 5c18 <unlink>
    for(pi = 0; pi < NCHILD; pi++){
...
0000000000001f8c <linkunlink>:
{
  ...
  unlink("x");
    ...
    1fb4:	c68080e7          	jalr	-920(ra) # 5c18 <unlink>
  pid = fork();
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    200e:	bbe080e7          	jalr	-1090(ra) # 5bc8 <exit>
      close(open("x", O_RDWR | O_CREATE));
    2012:	20200593          	li	a1,514
    2016:	8556                	mv	a0,s5
    2018:	00004097          	auipc	ra,0x4
    201c:	bf0080e7          	jalr	-1040(ra) # 5c08 <open>
    2020:	00004097          	auipc	ra,0x4
    2024:	bd0080e7          	jalr	-1072(ra) # 5bf0 <close>
  for(i = 0; i < 100; i++){
    ...
    2048:	bd4080e7          	jalr	-1068(ra) # 5c18 <unlink>
    204c:	bff1                	j	2028 <linkunlink+0x9c>
      link("cat", "x");
    204e:	85d6                	mv	a1,s5
    2050:	855e                	mv	a0,s7
    2052:	00004097          	auipc	ra,0x4
    2056:	bd6080e7          	jalr	-1066(ra) # 5c28 <link>
  ...
  if(pid)
    ...
    2066:	b6e080e7          	jalr	-1170(ra) # 5bd0 <wait>
}
    ...
    208a:	b42080e7          	jalr	-1214(ra) # 5bc8 <exit>
...
000000000000208e <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    20d0:	afc080e7          	jalr	-1284(ra) # 5bc8 <exit>
      exit(0);
    20d4:	00004097          	auipc	ra,0x4
    20d8:	af4080e7          	jalr	-1292(ra) # 5bc8 <exit>
  if (n == 0) {
  ...
  for(; n > 0; n--){
    ...
    20f0:	ae4080e7          	jalr	-1308(ra) # 5bd0 <wait>
  ...
  if(wait(0) != -1){
    ...
    2102:	ad2080e7          	jalr	-1326(ra) # 5bd0 <wait>
    2106:	57fd                	li	a5,-1
    ...
    2132:	a9a080e7          	jalr	-1382(ra) # 5bc8 <exit>
    ...
    214e:	a7e080e7          	jalr	-1410(ra) # 5bc8 <exit>
    ...
    216a:	a62080e7          	jalr	-1438(ra) # 5bc8 <exit>
...
000000000000216e <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    21ae:	a26080e7          	jalr	-1498(ra) # 5bd0 <wait>
    if(xstatus != -1)  // did kernel kill child?
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    21ea:	9e2080e7          	jalr	-1566(ra) # 5bc8 <exit>
    ...
    220c:	9c0080e7          	jalr	-1600(ra) # 5bc8 <exit>
      exit(1);
    2210:	4505                	li	a0,1
    2212:	00004097          	auipc	ra,0x4
    2216:	9b6080e7          	jalr	-1610(ra) # 5bc8 <exit>
...
000000000000221a <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    224e:	986080e7          	jalr	-1658(ra) # 5bd0 <wait>
    if(xstatus != -1)  // did kernel kill child?
  ...
  for( ; a != 0; a <<= 1){
    ...
    228e:	93e080e7          	jalr	-1730(ra) # 5bc8 <exit>
      *(char*)a = 99;
    ...
    22ba:	912080e7          	jalr	-1774(ra) # 5bc8 <exit>
      exit(1);
    22be:	4505                	li	a0,1
    22c0:	00004097          	auipc	ra,0x4
    22c4:	908080e7          	jalr	-1784(ra) # 5bc8 <exit>
...
00000000000022c8 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    22e0:	93c080e7          	jalr	-1732(ra) # 5c18 <unlink>
  pid = fork();
  ...
  wait(&xstatus);
    ...
    22fa:	8da080e7          	jalr	-1830(ra) # 5bd0 <wait>
  if(xstatus != 0)
  ...
  fd = open("bigarg-ok", 0);
    ...
    2312:	8fa080e7          	jalr	-1798(ra) # 5c08 <open>
  if(fd < 0){
    2316:	08054e63          	bltz	a0,23b2 <bigargtest+0xea>
  close(fd);
    231a:	00004097          	auipc	ra,0x4
    231e:	8d6080e7          	jalr	-1834(ra) # 5bf0 <close>
}
    ...
    2364:	8a0080e7          	jalr	-1888(ra) # 5c00 <exec>
    ...
    2378:	894080e7          	jalr	-1900(ra) # 5c08 <open>
    close(fd);
    237c:	00004097          	auipc	ra,0x4
    2380:	874080e7          	jalr	-1932(ra) # 5bf0 <close>
    exit(0);
    2384:	4501                	li	a0,0
    2386:	00004097          	auipc	ra,0x4
    238a:	842080e7          	jalr	-1982(ra) # 5bc8 <exit>
    ...
    23a6:	826080e7          	jalr	-2010(ra) # 5bc8 <exit>
    exit(xstatus);
    23aa:	00004097          	auipc	ra,0x4
    23ae:	81e080e7          	jalr	-2018(ra) # 5bc8 <exit>
    ...
    23ca:	802080e7          	jalr	-2046(ra) # 5bc8 <exit>
...
00000000000023ce <stacktest>:
{
  ...
  wait(&xstatus);
    ...
    23f0:	7e4080e7          	jalr	2020(ra) # 5bd0 <wait>
  if(xstatus == -1)  // kernel killed child?
    ...
    2402:	7ca080e7          	jalr	1994(ra) # 5bc8 <exit>
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    2428:	7a4080e7          	jalr	1956(ra) # 5bc8 <exit>
    printf("%s: fork failed\n", s);
    242c:	85a6                	mv	a1,s1
    ...
    2444:	788080e7          	jalr	1928(ra) # 5bc8 <exit>
    exit(0);
    2448:	4501                	li	a0,0
    244a:	00003097          	auipc	ra,0x3
    244e:	77e080e7          	jalr	1918(ra) # 5bc8 <exit>
...
0000000000002452 <textwrite>:
{
  ...
  wait(&xstatus);
    ...
    2474:	760080e7          	jalr	1888(ra) # 5bd0 <wait>
  if(xstatus == -1)  // kernel killed child?
    ...
    2486:	746080e7          	jalr	1862(ra) # 5bc8 <exit>
    *addr = 10;
    248a:	47a9                	li	a5,10
    ...
    2496:	736080e7          	jalr	1846(ra) # 5bc8 <exit>
    printf("%s: fork failed\n", s);
    249a:	85a6                	mv	a1,s1
    ...
    24b2:	71a080e7          	jalr	1818(ra) # 5bc8 <exit>
    exit(0);
    24b6:	4501                	li	a0,0
    24b8:	00003097          	auipc	ra,0x3
    24bc:	710080e7          	jalr	1808(ra) # 5bc8 <exit>
...
00000000000024c0 <manywrites>:
{
  ...
  for(int ci = 0; ci < nchildren; ci++){
    ...
    2500:	6d4080e7          	jalr	1748(ra) # 5bd0 <wait>
    if(st != 0)
  ...
  exit(0);
    ...
    2514:	6b8080e7          	jalr	1720(ra) # 5bc8 <exit>
      printf("fork failed\n");
    ...
    252e:	69e080e7          	jalr	1694(ra) # 5bc8 <exit>
      name[0] = 'b';
    ...
    254e:	6ce080e7          	jalr	1742(ra) # 5c18 <unlink>
    2552:	4bf9                	li	s7,30
          int cc = write(fd, buf, sz);
    ...
    256e:	69e080e7          	jalr	1694(ra) # 5c08 <open>
    2572:	892a                	mv	s2,a0
          if(fd < 0){
    ...
    2580:	66c080e7          	jalr	1644(ra) # 5be8 <write>
          if(cc != sz){
    ...
    2590:	664080e7          	jalr	1636(ra) # 5bf0 <close>
        for(int i = 0; i < ci+1; i++){
    ...
    25a2:	67a080e7          	jalr	1658(ra) # 5c18 <unlink>
    ...
    25b4:	668080e7          	jalr	1640(ra) # 5c18 <unlink>
      exit(0);
    25b8:	4501                	li	a0,0
    25ba:	00003097          	auipc	ra,0x3
    25be:	60e080e7          	jalr	1550(ra) # 5bc8 <exit>
    ...
    25de:	5ee080e7          	jalr	1518(ra) # 5bc8 <exit>
            printf("%s: write(%d) ret %d\n", s, sz, cc);
    25e2:	86aa                	mv	a3,a0
    ...
    25fe:	5ce080e7          	jalr	1486(ra) # 5bc8 <exit>
      exit(st);
    2602:	00003097          	auipc	ra,0x3
    2606:	5c6080e7          	jalr	1478(ra) # 5bc8 <exit>
...
000000000000260a <copyinstr3>:
{
  ...
  sbrk(8192);
    ...
    261a:	63a080e7          	jalr	1594(ra) # 5c50 <sbrk>
  uint64 top = (uint64) sbrk(0);
    261e:	4501                	li	a0,0
    2620:	00003097          	auipc	ra,0x3
    2624:	630080e7          	jalr	1584(ra) # 5c50 <sbrk>
  if((top % PGSIZE) != 0){
  ...
  top = (uint64) sbrk(0);
    ...
    2634:	620080e7          	jalr	1568(ra) # 5c50 <sbrk>
  if(top % PGSIZE){
  ...
  *b = 'x';
  ...
  int ret = unlink(b);
    ...
    2650:	5cc080e7          	jalr	1484(ra) # 5c18 <unlink>
  if(ret != -1){
    2654:	57fd                	li	a5,-1
  ...
  int fd = open(b, O_CREATE | O_WRONLY);
    ...
    2664:	5a8080e7          	jalr	1448(ra) # 5c08 <open>
  if(fd != -1){
    2668:	57fd                	li	a5,-1
  ...
  ret = link(b, b);
    ...
    2676:	5b6080e7          	jalr	1462(ra) # 5c28 <link>
  if(ret != -1){
    267a:	57fd                	li	a5,-1
  ...
  ret = exec(b, args);
    ...
    269a:	56a080e7          	jalr	1386(ra) # 5c00 <exec>
  if(ret != -1){
    269e:	57fd                	li	a5,-1
    ...
    26bc:	598080e7          	jalr	1432(ra) # 5c50 <sbrk>
    ...
    26d8:	4f4080e7          	jalr	1268(ra) # 5bc8 <exit>
    printf("unlink(%s) returned %d, not -1\n", b, ret);
    26dc:	862a                	mv	a2,a0
    26de:	85a6                	mv	a1,s1
    ...
    26f6:	4d6080e7          	jalr	1238(ra) # 5bc8 <exit>
    printf("open(%s) returned %d, not -1\n", b, fd);
    26fa:	862a                	mv	a2,a0
    26fc:	85a6                	mv	a1,s1
    ...
    2714:	4b8080e7          	jalr	1208(ra) # 5bc8 <exit>
    printf("link(%s, %s) returned %d, not -1\n", b, b, ret);
    2718:	86aa                	mv	a3,a0
    271a:	8626                	mv	a2,s1
    271c:	85a6                	mv	a1,s1
    ...
    2734:	498080e7          	jalr	1176(ra) # 5bc8 <exit>
    printf("exec(%s) returned %d, not -1\n", b, fd);
    2738:	567d                	li	a2,-1
    273a:	85a6                	mv	a1,s1
    ...
    2752:	47a080e7          	jalr	1146(ra) # 5bc8 <exit>
...
0000000000002756 <rwsbrk>:
{
  ...
  uint64 a = (uint64) sbrk(8192);
    ...
    2768:	4ec080e7          	jalr	1260(ra) # 5c50 <sbrk>
  ...
  if ((uint64) sbrk(-8192) ==  0xffffffffffffffffLL) {
    ...
    277a:	4da080e7          	jalr	1242(ra) # 5c50 <sbrk>
    277e:	57fd                	li	a5,-1
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    2794:	478080e7          	jalr	1144(ra) # 5c08 <open>
    2798:	892a                	mv	s2,a0
  if(fd < 0){
  ...
  n = write(fd, (void*)(a+4096), 1024);
    ...
    27ac:	440080e7          	jalr	1088(ra) # 5be8 <write>
    27b0:	862a                	mv	a2,a0
  if(n >= 0){
    ...
    27ce:	3fe080e7          	jalr	1022(ra) # 5bc8 <exit>
    ...
    27e8:	3e4080e7          	jalr	996(ra) # 5bc8 <exit>
    ...
    2802:	3ca080e7          	jalr	970(ra) # 5bc8 <exit>
  ...
  n = read(fd, (void*)(a+4096), 10);
    ...
    285a:	38a080e7          	jalr	906(ra) # 5be0 <read>
    285e:	862a                	mv	a2,a0
  if(n >= 0){
    ...
    287c:	350080e7          	jalr	848(ra) # 5bc8 <exit>
    printf("open(rwsbrk) failed\n");
    ...
    2896:	336080e7          	jalr	822(ra) # 5bc8 <exit>
  close(fd);
    289a:	854a                	mv	a0,s2
    289c:	00003097          	auipc	ra,0x3
    28a0:	354080e7          	jalr	852(ra) # 5bf0 <close>
  exit(0);
    28a4:	4501                	li	a0,0
    28a6:	00003097          	auipc	ra,0x3
    28aa:	322080e7          	jalr	802(ra) # 5bc8 <exit>
...
00000000000028ae <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    28d6:	37e080e7          	jalr	894(ra) # 5c50 <sbrk>
    ...
    28fc:	2d0080e7          	jalr	720(ra) # 5bc8 <exit>
    ...
    2916:	2b6080e7          	jalr	694(ra) # 5bc8 <exit>
      exit(0);
    291a:	4501                	li	a0,0
    291c:	00003097          	auipc	ra,0x3
    2920:	2ac080e7          	jalr	684(ra) # 5bc8 <exit>
  wait(&xstatus);
    2924:	fcc40513          	addi	a0,s0,-52
    2928:	00003097          	auipc	ra,0x3
    292c:	2a8080e7          	jalr	680(ra) # 5bd0 <wait>
  if(xstatus == 1){
  ...
  a = sbrk(0);
    ...
    2940:	314080e7          	jalr	788(ra) # 5c50 <sbrk>
    2944:	84aa                	mv	s1,a0
  for(i = 0; i < 5000; i++){
    2946:	4901                	li	s2,0
    ...
    2968:	264080e7          	jalr	612(ra) # 5bc8 <exit>
    a = b + 1;
    296c:	84be                	mv	s1,a5
    b = sbrk(1);
    296e:	4505                	li	a0,1
    2970:	00003097          	auipc	ra,0x3
    2974:	2e0080e7          	jalr	736(ra) # 5c50 <sbrk>
    if(b != a){
  ...
  c = sbrk(1);
    ...
    29a0:	2b4080e7          	jalr	692(ra) # 5c50 <sbrk>
  c = sbrk(1);
    29a4:	4505                	li	a0,1
    29a6:	00003097          	auipc	ra,0x3
    29aa:	2aa080e7          	jalr	682(ra) # 5c50 <sbrk>
  if(c != a + 1){
    ...
    29cc:	200080e7          	jalr	512(ra) # 5bc8 <exit>
    ...
    29ee:	1de080e7          	jalr	478(ra) # 5bc8 <exit>
...
0000000000002a34 <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  a = sbrk(0);
    ...
    2aa0:	1b4080e7          	jalr	436(ra) # 5c50 <sbrk>
    2aa4:	84aa                	mv	s1,a0
  c = sbrk(-PGSIZE);
    2aa6:	757d                	lui	a0,0xfffff
    2aa8:	00003097          	auipc	ra,0x3
    2aac:	1a8080e7          	jalr	424(ra) # 5c50 <sbrk>
  ...
  c = sbrk(0);
    ...
    2abc:	198080e7          	jalr	408(ra) # 5c50 <sbrk>
  if(c != a - PGSIZE){
  ...
  a = sbrk(0);
    ...
    2b0c:	148080e7          	jalr	328(ra) # 5c50 <sbrk>
    2b10:	84aa                	mv	s1,a0
  c = sbrk(-(sbrk(0) - oldbrk));
    2b12:	4501                	li	a0,0
    2b14:	00003097          	auipc	ra,0x3
    2b18:	13c080e7          	jalr	316(ra) # 5c50 <sbrk>
    2b1c:	40a9053b          	subw	a0,s2,a0
    2b20:	00003097          	auipc	ra,0x3
    2b24:	130080e7          	jalr	304(ra) # 5c50 <sbrk>
  if(c != a){
    ...
    2b54:	078080e7          	jalr	120(ra) # 5bc8 <exit>
    ...
    2b70:	05c080e7          	jalr	92(ra) # 5bc8 <exit>
    ...
    2b90:	03c080e7          	jalr	60(ra) # 5bc8 <exit>
    ...
    2bb0:	01c080e7          	jalr	28(ra) # 5bc8 <exit>
    ...
    2bcc:	000080e7          	jalr	ra # 5bc8 <exit>
    ...
    2bec:	fe0080e7          	jalr	-32(ra) # 5bc8 <exit>
...
0000000000002bf0 <sbrkarg>:
{
  ...
  a = sbrk(PGSIZE);
    ...
    2c06:	04e080e7          	jalr	78(ra) # 5c50 <sbrk>
    2c0a:	892a                	mv	s2,a0
  ...
  if ((n = write(fd, a, PGSIZE)) < 0) {
    ...
    2c40:	fac080e7          	jalr	-84(ra) # 5be8 <write>
    2c44:	04054663          	bltz	a0,2c90 <sbrkarg+0xa0>
  close(fd);
    2c48:	8526                	mv	a0,s1
    2c4a:	00003097          	auipc	ra,0x3
    2c4e:	fa6080e7          	jalr	-90(ra) # 5bf0 <close>
  a = sbrk(PGSIZE);
    2c52:	6505                	lui	a0,0x1
    2c54:	00003097          	auipc	ra,0x3
    2c58:	ffc080e7          	jalr	-4(ra) # 5c50 <sbrk>
  if(pipe((int *) a) != 0){
    2c5c:	00003097          	auipc	ra,0x3
    2c60:	f7c080e7          	jalr	-132(ra) # 5bd8 <pipe>
    ...
    2c8c:	f40080e7          	jalr	-192(ra) # 5bc8 <exit>
    ...
    2ca8:	f24080e7          	jalr	-220(ra) # 5bc8 <exit>
    printf("%s: pipe() failed\n", s);
    2cac:	85ce                	mv	a1,s3
    ...
    2cc4:	f08080e7          	jalr	-248(ra) # 5bc8 <exit>
...
0000000000002cc8 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2ce4:	f28080e7          	jalr	-216(ra) # 5c08 <open>
  if (fd < 0) {
  ...
  read(fd, sbrk(0) - 1, -1);
    ...
    2cf4:	f60080e7          	jalr	-160(ra) # 5c50 <sbrk>
    2cf8:	567d                	li	a2,-1
    2cfa:	fff50593          	addi	a1,a0,-1
    2cfe:	8526                	mv	a0,s1
    2d00:	00003097          	auipc	ra,0x3
    2d04:	ee0080e7          	jalr	-288(ra) # 5be0 <read>
  close(fd);
    2d08:	8526                	mv	a0,s1
    2d0a:	00003097          	auipc	ra,0x3
    2d0e:	ee6080e7          	jalr	-282(ra) # 5bf0 <close>
}
    ...
    2d36:	e96080e7          	jalr	-362(ra) # 5bc8 <exit>
...
0000000000002d3a <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2d54:	f00080e7          	jalr	-256(ra) # 5c50 <sbrk>
    sbrk(-sz);
    2d58:	40a0053b          	negw	a0,a0
    2d5c:	00003097          	auipc	ra,0x3
    2d60:	ef4080e7          	jalr	-268(ra) # 5c50 <sbrk>
    exit(0);
    2d64:	4501                	li	a0,0
    2d66:	00003097          	auipc	ra,0x3
    2d6a:	e62080e7          	jalr	-414(ra) # 5bc8 <exit>
    printf("fork failed\n");
    ...
    2d84:	e48080e7          	jalr	-440(ra) # 5bc8 <exit>
  wait(0);
    2d88:	4501                	li	a0,0
    2d8a:	00003097          	auipc	ra,0x3
    2d8e:	e46080e7          	jalr	-442(ra) # 5bd0 <wait>
  pid = fork();
  ...
  if(pid == 0){
    ...
    2da4:	eb0080e7          	jalr	-336(ra) # 5c50 <sbrk>
    sbrk(-(sz - 3500));
    ...
    2db6:	e9e080e7          	jalr	-354(ra) # 5c50 <sbrk>
    exit(0);
    2dba:	4501                	li	a0,0
    2dbc:	00003097          	auipc	ra,0x3
    2dc0:	e0c080e7          	jalr	-500(ra) # 5bc8 <exit>
    printf("fork failed\n");
    ...
    2dda:	df2080e7          	jalr	-526(ra) # 5bc8 <exit>
  wait(0);
    2dde:	4501                	li	a0,0
    2de0:	00003097          	auipc	ra,0x3
    2de4:	df0080e7          	jalr	-528(ra) # 5bd0 <wait>
  pid = fork();
  ...
  if(pid == 0){
    ...
    2dfa:	e5a080e7          	jalr	-422(ra) # 5c50 <sbrk>
    ...
    2e0c:	e48080e7          	jalr	-440(ra) # 5c50 <sbrk>
    sbrk(-10);
    2e10:	5559                	li	a0,-10
    2e12:	00003097          	auipc	ra,0x3
    2e16:	e3e080e7          	jalr	-450(ra) # 5c50 <sbrk>
    exit(0);
    2e1a:	4501                	li	a0,0
    2e1c:	00003097          	auipc	ra,0x3
    2e20:	dac080e7          	jalr	-596(ra) # 5bc8 <exit>
    printf("fork failed\n");
    ...
    2e3a:	d92080e7          	jalr	-622(ra) # 5bc8 <exit>
  wait(0);
    2e3e:	4501                	li	a0,0
    2e40:	00003097          	auipc	ra,0x3
    2e44:	d90080e7          	jalr	-624(ra) # 5bd0 <wait>
  exit(0);
    2e48:	4501                	li	a0,0
    2e4a:	00003097          	auipc	ra,0x3
    2e4e:	d7e080e7          	jalr	-642(ra) # 5bc8 <exit>
...
0000000000002e52 <sbrklast>:
{
  ...
  uint64 top = (uint64) sbrk(0);
    ...
    2e68:	dec080e7          	jalr	-532(ra) # 5c50 <sbrk>
  if((top % 4096) != 0)
  ...
  sbrk(4096);
    ...
    2e78:	ddc080e7          	jalr	-548(ra) # 5c50 <sbrk>
  sbrk(10);
    2e7c:	4529                	li	a0,10
    2e7e:	00003097          	auipc	ra,0x3
    2e82:	dd2080e7          	jalr	-558(ra) # 5c50 <sbrk>
  sbrk(-20);
    2e86:	5531                	li	a0,-20
    2e88:	00003097          	auipc	ra,0x3
    2e8c:	dc8080e7          	jalr	-568(ra) # 5c50 <sbrk>
  top = (uint64) sbrk(0);
    2e90:	4501                	li	a0,0
    2e92:	00003097          	auipc	ra,0x3
    2e96:	dbe080e7          	jalr	-578(ra) # 5c50 <sbrk>
    2e9a:	84aa                	mv	s1,a0
  char *p = (char *) (top - 64);
  ...
  int fd = open(p, O_RDWR|O_CREATE);
    ...
    2eb6:	d56080e7          	jalr	-682(ra) # 5c08 <open>
    2eba:	89aa                	mv	s3,a0
  write(fd, p, 1);
    2ebc:	4605                	li	a2,1
    2ebe:	85ca                	mv	a1,s2
    2ec0:	00003097          	auipc	ra,0x3
    2ec4:	d28080e7          	jalr	-728(ra) # 5be8 <write>
  close(fd);
    2ec8:	854e                	mv	a0,s3
    2eca:	00003097          	auipc	ra,0x3
    2ece:	d26080e7          	jalr	-730(ra) # 5bf0 <close>
  fd = open(p, O_RDWR);
    2ed2:	4589                	li	a1,2
    2ed4:	854a                	mv	a0,s2
    2ed6:	00003097          	auipc	ra,0x3
    2eda:	d32080e7          	jalr	-718(ra) # 5c08 <open>
  p[0] = '\0';
  ...
  read(fd, p, 1);
    ...
    2eea:	cfa080e7          	jalr	-774(ra) # 5be0 <read>
  if(p[0] != 'x')
    ...
    2f14:	d40080e7          	jalr	-704(ra) # 5c50 <sbrk>
    2f18:	bfa9                	j	2e72 <sbrklast+0x20>
    exit(1);
    2f1a:	4505                	li	a0,1
    2f1c:	00003097          	auipc	ra,0x3
    2f20:	cac080e7          	jalr	-852(ra) # 5bc8 <exit>
...
0000000000002f24 <sbrk8000>:
{
  ...
  sbrk(0x80000004);
    ...
    2f36:	d1e080e7          	jalr	-738(ra) # 5c50 <sbrk>
  volatile char *top = sbrk(0);
    2f3a:	4501                	li	a0,0
    2f3c:	00003097          	auipc	ra,0x3
    2f40:	d14080e7          	jalr	-748(ra) # 5c50 <sbrk>
  *(top-1) = *(top-1) + 1;
...
0000000000002f5a <execout>:
{
  ...
  for(int avail = 0; avail < 15; avail++){
    ...
    2f84:	c50080e7          	jalr	-944(ra) # 5bd0 <wait>
  for(int avail = 0; avail < 15; avail++){
  ...
  exit(0);
    ...
    2f94:	c38080e7          	jalr	-968(ra) # 5bc8 <exit>
      printf("fork failed\n");
    ...
    2fae:	c1e080e7          	jalr	-994(ra) # 5bc8 <exit>
        if(a == 0xffffffffffffffffLL)
    2fb2:	59fd                	li	s3,-1
        *(char*)(a + 4096 - 1) = 1;
    2fb4:	4a05                	li	s4,1
    ...
    2fbc:	c98080e7          	jalr	-872(ra) # 5c50 <sbrk>
        if(a == 0xffffffffffffffffLL)
    ...
    2fd8:	c7c080e7          	jalr	-900(ra) # 5c50 <sbrk>
      for(int i = 0; i < avail; i++)
    ...
    2fe8:	c0c080e7          	jalr	-1012(ra) # 5bf0 <close>
      char *args[] = { "echo", "x", 0 };
    ...
    3010:	bf4080e7          	jalr	-1036(ra) # 5c00 <exec>
      exit(0);
    3014:	4501                	li	a0,0
    3016:	00003097          	auipc	ra,0x3
    301a:	bb2080e7          	jalr	-1102(ra) # 5bc8 <exit>
...
000000000000301e <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    3036:	bfe080e7          	jalr	-1026(ra) # 5c30 <mkdir>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    3048:	bec080e7          	jalr	-1044(ra) # 5c30 <mkdir>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    30aa:	b8a080e7          	jalr	-1142(ra) # 5c30 <mkdir>
  ...
  unlink("12345678901234");
    ...
    3132:	a9a080e7          	jalr	-1382(ra) # 5bc8 <exit>
    ...
    314e:	a7e080e7          	jalr	-1410(ra) # 5bc8 <exit>
    ...
    316a:	a62080e7          	jalr	-1438(ra) # 5bc8 <exit>
    ...
    3186:	a46080e7          	jalr	-1466(ra) # 5bc8 <exit>
    ...
    31a2:	a2a080e7          	jalr	-1494(ra) # 5bc8 <exit>
    ...
    31be:	a0e080e7          	jalr	-1522(ra) # 5bc8 <exit>
...
00000000000031c2 <diskfull>:
{
  ...
  unlink("diskfulldir");
    ...
    3200:	a1c080e7          	jalr	-1508(ra) # 5c18 <unlink>
  for(fi = 0; done == 0; fi++){
    3204:	4a01                	li	s4,0
    name[0] = 'b';
    ...
    3236:	9be080e7          	jalr	-1602(ra) # 5bf0 <close>
    close(fd);
    323a:	854a                	mv	a0,s2
    323c:	00003097          	auipc	ra,0x3
    3240:	9b4080e7          	jalr	-1612(ra) # 5bf0 <close>
  for(fi = 0; done == 0; fi++){
  ...
  if(mkdir("diskfulldir") == 0)
    ...
    32ba:	97a080e7          	jalr	-1670(ra) # 5c30 <mkdir>
  ...
  unlink("diskfulldir");
    ...
    32ce:	94e080e7          	jalr	-1714(ra) # 5c18 <unlink>
  for(int i = 0; i < nzz; i++){
    32d2:	4481                	li	s1,0
    name[0] = 'z';
  ...
  for(int i = 0; i < nzz; i++){
    ...
    3314:	908080e7          	jalr	-1784(ra) # 5c18 <unlink>
  for(int i = 0; i < nzz; i++){
  ...
  for(int i = 0; i < fi; i++){
    ...
    3350:	8cc080e7          	jalr	-1844(ra) # 5c18 <unlink>
  for(int i = 0; i < fi; i++){
    ...
    338e:	866080e7          	jalr	-1946(ra) # 5bf0 <close>
  for(fi = 0; done == 0; fi++){
    ...
    33de:	80e080e7          	jalr	-2034(ra) # 5be8 <write>
...
0000000000003402 <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    341a:	81a080e7          	jalr	-2022(ra) # 5c30 <mkdir>
  ...
  if(chdir("iputdir") < 0){
    ...
    342e:	80e080e7          	jalr	-2034(ra) # 5c38 <chdir>
  ...
  if(unlink("../iputdir") < 0){
    ...
    3442:	7da080e7          	jalr	2010(ra) # 5c18 <unlink>
  ...
  if(chdir("/") < 0){
    ...
    3456:	7e6080e7          	jalr	2022(ra) # 5c38 <chdir>
    ...
    3480:	74c080e7          	jalr	1868(ra) # 5bc8 <exit>
    ...
    349c:	730080e7          	jalr	1840(ra) # 5bc8 <exit>
    ...
    34b8:	714080e7          	jalr	1812(ra) # 5bc8 <exit>
    ...
    34d4:	6f8080e7          	jalr	1784(ra) # 5bc8 <exit>
...
00000000000034d8 <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    34fe:	736080e7          	jalr	1846(ra) # 5c30 <mkdir>
    ...
    3512:	72a080e7          	jalr	1834(ra) # 5c38 <chdir>
    ...
    3526:	6f6080e7          	jalr	1782(ra) # 5c18 <unlink>
    352a:	06054163          	bltz	a0,358c <exitiputtest+0xb4>
    exit(0);
    352e:	4501                	li	a0,0
    3530:	00002097          	auipc	ra,0x2
    3534:	698080e7          	jalr	1688(ra) # 5bc8 <exit>
    printf("%s: fork failed\n", s);
    3538:	85a6                	mv	a1,s1
    ...
    3550:	67c080e7          	jalr	1660(ra) # 5bc8 <exit>
      printf("%s: mkdir failed\n", s);
    3554:	85a6                	mv	a1,s1
    ...
    356c:	660080e7          	jalr	1632(ra) # 5bc8 <exit>
    ...
    3588:	644080e7          	jalr	1604(ra) # 5bc8 <exit>
      printf("%s: unlink ../iputdir failed\n", s);
    358c:	85a6                	mv	a1,s1
    ...
    35a4:	628080e7          	jalr	1576(ra) # 5bc8 <exit>
  wait(&xstatus);
    35a8:	fdc40513          	addi	a0,s0,-36
    35ac:	00002097          	auipc	ra,0x2
    35b0:	624080e7          	jalr	1572(ra) # 5bd0 <wait>
  exit(xstatus);
    35b4:	fdc42503          	lw	a0,-36(s0)
    35b8:	00002097          	auipc	ra,0x2
    35bc:	610080e7          	jalr	1552(ra) # 5bc8 <exit>
...
00000000000035c0 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    35d8:	65c080e7          	jalr	1628(ra) # 5c30 <mkdir>
  ...
  if(chdir("dir0") < 0){
    ...
    35ec:	650080e7          	jalr	1616(ra) # 5c38 <chdir>
  ...
  if(chdir("..") < 0){
    ...
    3600:	63c080e7          	jalr	1596(ra) # 5c38 <chdir>
  ...
  if(unlink("dir0") < 0){
    ...
    3614:	608080e7          	jalr	1544(ra) # 5c18 <unlink>
    ...
    363e:	58e080e7          	jalr	1422(ra) # 5bc8 <exit>
    ...
    365a:	572080e7          	jalr	1394(ra) # 5bc8 <exit>
    printf("%s: chdir .. failed\n", s);
    365e:	85a6                	mv	a1,s1
    ...
    3676:	556080e7          	jalr	1366(ra) # 5bc8 <exit>
    ...
    3692:	53a080e7          	jalr	1338(ra) # 5bc8 <exit>
...
0000000000003696 <subdir>:
{
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    36d8:	534080e7          	jalr	1332(ra) # 5c08 <open>
    36dc:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    371e:	516080e7          	jalr	1302(ra) # 5c30 <mkdir>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    3736:	4d6080e7          	jalr	1238(ra) # 5c08 <open>
    373a:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    3782:	462080e7          	jalr	1122(ra) # 5be0 <read>
  if(cc != 2 || buf[0] != 'f'){
    3786:	4789                	li	a5,2
  ...
  close(fd);
    ...
    37a2:	452080e7          	jalr	1106(ra) # 5bf0 <close>
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    37ba:	472080e7          	jalr	1138(ra) # 5c28 <link>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    37ce:	44e080e7          	jalr	1102(ra) # 5c18 <unlink>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    37e4:	428080e7          	jalr	1064(ra) # 5c08 <open>
  ...
  if(chdir("dd") != 0){
    ...
    37f8:	444080e7          	jalr	1092(ra) # 5c38 <chdir>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    380c:	430080e7          	jalr	1072(ra) # 5c38 <chdir>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    3820:	41c080e7          	jalr	1052(ra) # 5c38 <chdir>
  ...
  if(chdir("./..") != 0){
    ...
    3834:	408080e7          	jalr	1032(ra) # 5c38 <chdir>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    384a:	3c2080e7          	jalr	962(ra) # 5c08 <open>
    384e:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    389c:	370080e7          	jalr	880(ra) # 5c08 <open>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    38b4:	358080e7          	jalr	856(ra) # 5c08 <open>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    38cc:	340080e7          	jalr	832(ra) # 5c08 <open>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    38e2:	32a080e7          	jalr	810(ra) # 5c08 <open>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    38f8:	314080e7          	jalr	788(ra) # 5c08 <open>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    3914:	318080e7          	jalr	792(ra) # 5c28 <link>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    3930:	2fc080e7          	jalr	764(ra) # 5c28 <link>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    394c:	2e0080e7          	jalr	736(ra) # 5c28 <link>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    3960:	2d4080e7          	jalr	724(ra) # 5c30 <mkdir>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    3974:	2c0080e7          	jalr	704(ra) # 5c30 <mkdir>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    3988:	2ac080e7          	jalr	684(ra) # 5c30 <mkdir>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    399c:	280080e7          	jalr	640(ra) # 5c18 <unlink>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    39b0:	26c080e7          	jalr	620(ra) # 5c18 <unlink>
  ...
  if(chdir("dd/ff") == 0){
    ...
    39c4:	278080e7          	jalr	632(ra) # 5c38 <chdir>
  ...
  if(chdir("dd/xx") == 0){
    ...
    39d8:	264080e7          	jalr	612(ra) # 5c38 <chdir>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    39ec:	230080e7          	jalr	560(ra) # 5c18 <unlink>
  ...
  if(unlink("dd/ff") != 0){
    ...
    3a00:	21c080e7          	jalr	540(ra) # 5c18 <unlink>
  ...
  if(unlink("dd") == 0){
    ...
    3a14:	208080e7          	jalr	520(ra) # 5c18 <unlink>
  ...
  if(unlink("dd/dd") < 0){
    ...
    3a28:	1f4080e7          	jalr	500(ra) # 5c18 <unlink>
  ...
  if(unlink("dd") < 0){
    ...
    3a3c:	1e0080e7          	jalr	480(ra) # 5c18 <unlink>
    ...
    3a68:	164080e7          	jalr	356(ra) # 5bc8 <exit>
    ...
    3a84:	148080e7          	jalr	328(ra) # 5bc8 <exit>
    ...
    3aa0:	12c080e7          	jalr	300(ra) # 5bc8 <exit>
    ...
    3abc:	110080e7          	jalr	272(ra) # 5bc8 <exit>
    ...
    3ad8:	0f4080e7          	jalr	244(ra) # 5bc8 <exit>
    ...
    3af4:	0d8080e7          	jalr	216(ra) # 5bc8 <exit>
    ...
    3b10:	0bc080e7          	jalr	188(ra) # 5bc8 <exit>
    ...
    3b2c:	0a0080e7          	jalr	160(ra) # 5bc8 <exit>
    ...
    3b48:	084080e7          	jalr	132(ra) # 5bc8 <exit>
    ...
    3b64:	068080e7          	jalr	104(ra) # 5bc8 <exit>
    ...
    3b80:	04c080e7          	jalr	76(ra) # 5bc8 <exit>
    ...
    3b9c:	030080e7          	jalr	48(ra) # 5bc8 <exit>
    ...
    3bb8:	014080e7          	jalr	20(ra) # 5bc8 <exit>
    printf("%s: chdir ./.. failed\n", s);
    3bbc:	85ca                	mv	a1,s2
    ...
    3bd4:	ff8080e7          	jalr	-8(ra) # 5bc8 <exit>
    ...
    3bf0:	fdc080e7          	jalr	-36(ra) # 5bc8 <exit>
    ...
    3c0c:	fc0080e7          	jalr	-64(ra) # 5bc8 <exit>
    printf("%s: open (unlinked) dd/dd/ff succeeded!\n", s);
    3c10:	85ca                	mv	a1,s2
    ...
    3c28:	fa4080e7          	jalr	-92(ra) # 5bc8 <exit>
    ...
    3c44:	f88080e7          	jalr	-120(ra) # 5bc8 <exit>
    ...
    3c60:	f6c080e7          	jalr	-148(ra) # 5bc8 <exit>
    ...
    3c7c:	f50080e7          	jalr	-176(ra) # 5bc8 <exit>
    ...
    3c98:	f34080e7          	jalr	-204(ra) # 5bc8 <exit>
    ...
    3cb4:	f18080e7          	jalr	-232(ra) # 5bc8 <exit>
    ...
    3cd0:	efc080e7          	jalr	-260(ra) # 5bc8 <exit>
    ...
    3cec:	ee0080e7          	jalr	-288(ra) # 5bc8 <exit>
    ...
    3d08:	ec4080e7          	jalr	-316(ra) # 5bc8 <exit>
    ...
    3d24:	ea8080e7          	jalr	-344(ra) # 5bc8 <exit>
    ...
    3d40:	e8c080e7          	jalr	-372(ra) # 5bc8 <exit>
    ...
    3d5c:	e70080e7          	jalr	-400(ra) # 5bc8 <exit>
    ...
    3d78:	e54080e7          	jalr	-428(ra) # 5bc8 <exit>
    ...
    3d94:	e38080e7          	jalr	-456(ra) # 5bc8 <exit>
    ...
    3db0:	e1c080e7          	jalr	-484(ra) # 5bc8 <exit>
    ...
    3dcc:	e00080e7          	jalr	-512(ra) # 5bc8 <exit>
    printf("%s: unlink dd/dd/ff failed\n", s);
    3dd0:	85ca                	mv	a1,s2
    ...
    3de8:	de4080e7          	jalr	-540(ra) # 5bc8 <exit>
    ...
    3e04:	dc8080e7          	jalr	-568(ra) # 5bc8 <exit>
    ...
    3e20:	dac080e7          	jalr	-596(ra) # 5bc8 <exit>
    ...
    3e3c:	d90080e7          	jalr	-624(ra) # 5bc8 <exit>
    ...
    3e58:	d74080e7          	jalr	-652(ra) # 5bc8 <exit>
...
0000000000003e5c <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    3e74:	dc0080e7          	jalr	-576(ra) # 5c30 <mkdir>
  ...
  if(chdir("dots") != 0){
    ...
    3e86:	db6080e7          	jalr	-586(ra) # 5c38 <chdir>
  ...
  if(unlink(".") == 0){
    ...
    3e98:	d84080e7          	jalr	-636(ra) # 5c18 <unlink>
  ...
  if(unlink("..") == 0){
    ...
    3eaa:	d72080e7          	jalr	-654(ra) # 5c18 <unlink>
  ...
  if(chdir("/") != 0){
    ...
    3ebc:	d80080e7          	jalr	-640(ra) # 5c38 <chdir>
  ...
  if(unlink("dots/.") == 0){
    ...
    3ece:	d4e080e7          	jalr	-690(ra) # 5c18 <unlink>
  ...
  if(unlink("dots/..") == 0){
    ...
    3ee0:	d3c080e7          	jalr	-708(ra) # 5c18 <unlink>
  ...
  if(unlink("dots") != 0){
    ...
    3ef2:	d2a080e7          	jalr	-726(ra) # 5c18 <unlink>
    ...
    3f1a:	cb2080e7          	jalr	-846(ra) # 5bc8 <exit>
    ...
    3f36:	c96080e7          	jalr	-874(ra) # 5bc8 <exit>
    printf("%s: rm . worked!\n", s);
    3f3a:	85a6                	mv	a1,s1
    ...
    3f52:	c7a080e7          	jalr	-902(ra) # 5bc8 <exit>
    printf("%s: rm .. worked!\n", s);
    3f56:	85a6                	mv	a1,s1
    ...
    3f6e:	c5e080e7          	jalr	-930(ra) # 5bc8 <exit>
    printf("%s: chdir / failed\n", s);
    3f72:	85a6                	mv	a1,s1
    ...
    3f8a:	c42080e7          	jalr	-958(ra) # 5bc8 <exit>
    ...
    3fa6:	c26080e7          	jalr	-986(ra) # 5bc8 <exit>
    printf("%s: unlink dots/.. worked!\n", s);
    3faa:	85a6                	mv	a1,s1
    ...
    3fc2:	c0a080e7          	jalr	-1014(ra) # 5bc8 <exit>
    ...
    3fde:	bee080e7          	jalr	-1042(ra) # 5bc8 <exit>
...
0000000000003fe2 <dirfile>:
{
  ...
  fd = open("dirfile/xx", 0);
    ...
    4030:	bdc080e7          	jalr	-1060(ra) # 5c08 <open>
  if(fd >= 0){
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    4048:	bc4080e7          	jalr	-1084(ra) # 5c08 <open>
  if(fd >= 0){
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    405c:	bd8080e7          	jalr	-1064(ra) # 5c30 <mkdir>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    4070:	bac080e7          	jalr	-1108(ra) # 5c18 <unlink>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    408c:	ba0080e7          	jalr	-1120(ra) # 5c28 <link>
  ...
  if(unlink("dirfile") != 0){
    ...
    40a0:	b7c080e7          	jalr	-1156(ra) # 5c18 <unlink>
  ...
  fd = open(".", O_RDWR);
    ...
    40b6:	b56080e7          	jalr	-1194(ra) # 5c08 <open>
  if(fd >= 0){
  ...
  fd = open(".", 0);
    ...
    40cc:	b40080e7          	jalr	-1216(ra) # 5c08 <open>
    40d0:	84aa                	mv	s1,a0
  if(write(fd, "x", 1) > 0){
    40d2:	4605                	li	a2,1
    ...
    40e0:	b0c080e7          	jalr	-1268(ra) # 5be8 <write>
    40e4:	10a04b63          	bgtz	a0,41fa <dirfile+0x218>
  close(fd);
    40e8:	8526                	mv	a0,s1
    40ea:	00002097          	auipc	ra,0x2
    40ee:	b06080e7          	jalr	-1274(ra) # 5bf0 <close>
}
    ...
    4116:	ab6080e7          	jalr	-1354(ra) # 5bc8 <exit>
    ...
    4132:	a9a080e7          	jalr	-1382(ra) # 5bc8 <exit>
    ...
    414e:	a7e080e7          	jalr	-1410(ra) # 5bc8 <exit>
    printf("%s: create dirfile/xx succeeded!\n", s);
    4152:	85ca                	mv	a1,s2
    ...
    416a:	a62080e7          	jalr	-1438(ra) # 5bc8 <exit>
    ...
    4186:	a46080e7          	jalr	-1466(ra) # 5bc8 <exit>
    ...
    41a2:	a2a080e7          	jalr	-1494(ra) # 5bc8 <exit>
    ...
    41be:	a0e080e7          	jalr	-1522(ra) # 5bc8 <exit>
    ...
    41da:	9f2080e7          	jalr	-1550(ra) # 5bc8 <exit>
    ...
    41f6:	9d6080e7          	jalr	-1578(ra) # 5bc8 <exit>
    ...
    4212:	9ba080e7          	jalr	-1606(ra) # 5bc8 <exit>
...
0000000000004216 <iref>:
{
    ...
    426a:	962080e7          	jalr	-1694(ra) # 5bc8 <exit>
    ...
    4286:	946080e7          	jalr	-1722(ra) # 5bc8 <exit>
      close(fd);
    428a:	00002097          	auipc	ra,0x2
    428e:	966080e7          	jalr	-1690(ra) # 5bf0 <close>
    4292:	a889                	j	42e4 <iref+0xce>
    unlink("xx");
    4294:	854e                	mv	a0,s3
    4296:	00002097          	auipc	ra,0x2
    429a:	982080e7          	jalr	-1662(ra) # 5c18 <unlink>
  for(i = 0; i < NINODE + 1; i++){
    ...
    42ee:	91e080e7          	jalr	-1762(ra) # 5c08 <open>
    if(fd >= 0)
    42f2:	fa0541e3          	bltz	a0,4294 <iref+0x7e>
      close(fd);
    42f6:	00002097          	auipc	ra,0x2
    42fa:	8fa080e7          	jalr	-1798(ra) # 5bf0 <close>
    ...
    431a:	922080e7          	jalr	-1758(ra) # 5c38 <chdir>
    unlink("irefd");
    431e:	854a                	mv	a0,s2
    4320:	00002097          	auipc	ra,0x2
    4324:	8f8080e7          	jalr	-1800(ra) # 5c18 <unlink>
  for(i = 0; i < NINODE + 1; i++){
  ...
  chdir("/");
    ...
    4338:	904080e7          	jalr	-1788(ra) # 5c38 <chdir>
}
...
0000000000004350 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    4368:	8cc080e7          	jalr	-1844(ra) # 5c30 <mkdir>
  ...
  if(pid == 0){
    ...
    438c:	880080e7          	jalr	-1920(ra) # 5c08 <open>
    if(fd >= 0){
    ...
    43ac:	820080e7          	jalr	-2016(ra) # 5bc8 <exit>
    ...
    43c8:	804080e7          	jalr	-2044(ra) # 5bc8 <exit>
    printf("%s: fork failed\n", s);
    43cc:	85a6                	mv	a1,s1
  ...
  if(unlink("oidir") != 0){
    ...
    4426:	7a6080e7          	jalr	1958(ra) # 5bc8 <exit>
  wait(&xstatus);
    442a:	fdc40513          	addi	a0,s0,-36
    442e:	00001097          	auipc	ra,0x1
    4432:	7a2080e7          	jalr	1954(ra) # 5bd0 <wait>
  exit(xstatus);
    4436:	fdc42503          	lw	a0,-36(s0)
    443a:	00001097          	auipc	ra,0x1
    443e:	78e080e7          	jalr	1934(ra) # 5bc8 <exit>
...
0000000000004442 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    445a:	7c2080e7          	jalr	1986(ra) # 5c18 <unlink>
  int pid = fork();
  ...
  sleep(20); // two seconds
    ...
    4472:	7ea080e7          	jalr	2026(ra) # 5c58 <sleep>
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    4486:	786080e7          	jalr	1926(ra) # 5c08 <open>
    448a:	00001097          	auipc	ra,0x1
    448e:	766080e7          	jalr	1894(ra) # 5bf0 <close>
  wait(0);
    4492:	4501                	li	a0,0
    4494:	00001097          	auipc	ra,0x1
    4498:	73c080e7          	jalr	1852(ra) # 5bd0 <wait>
  sleep(10); // one second
    449c:	4529                	li	a0,10
    449e:	00001097          	auipc	ra,0x1
    44a2:	7ba080e7          	jalr	1978(ra) # 5c58 <sleep>
}
    ...
    44c8:	704080e7          	jalr	1796(ra) # 5bc8 <exit>
    ...
    44dc:	730080e7          	jalr	1840(ra) # 5c08 <open>
      if(fd >= 0){
    ...
    44fa:	712080e7          	jalr	1810(ra) # 5c08 <open>
    44fe:	00001097          	auipc	ra,0x1
    4502:	6f2080e7          	jalr	1778(ra) # 5bf0 <close>
    4506:	b7f9                	j	44d4 <forkforkfork+0x92>
        exit(0);
    4508:	4501                	li	a0,0
    450a:	00001097          	auipc	ra,0x1
    450e:	6be080e7          	jalr	1726(ra) # 5bc8 <exit>
...
0000000000004512 <killstatus>:
{
    ...
    4540:	71c080e7          	jalr	1820(ra) # 5c58 <sleep>
    kill(pid1);
    4544:	8526                	mv	a0,s1
    4546:	00001097          	auipc	ra,0x1
    454a:	6b2080e7          	jalr	1714(ra) # 5bf8 <kill>
    wait(&xst);
    454e:	fcc40513          	addi	a0,s0,-52
    4552:	00001097          	auipc	ra,0x1
    4556:	67e080e7          	jalr	1662(ra) # 5bd0 <wait>
    if(xst != -1) {
  ...
  exit(0);
    ...
    456e:	65e080e7          	jalr	1630(ra) # 5bc8 <exit>
      printf("%s: fork failed\n", s);
    4572:	85d2                	mv	a1,s4
    ...
    458a:	642080e7          	jalr	1602(ra) # 5bc8 <exit>
        getpid();
    458e:	00001097          	auipc	ra,0x1
    4592:	6ba080e7          	jalr	1722(ra) # 5c48 <getpid>
      while(1) {
    ...
    45b0:	61c080e7          	jalr	1564(ra) # 5bc8 <exit>
...
00000000000045b4 <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    45f0:	5dc080e7          	jalr	1500(ra) # 5bc8 <exit>
  pid2 = fork();
  ...
  if(pid2 == 0)
    ...
    461e:	5ae080e7          	jalr	1454(ra) # 5bc8 <exit>
  pipe(pfds);
    4622:	fc840513          	addi	a0,s0,-56
    4626:	00001097          	auipc	ra,0x1
    462a:	5b2080e7          	jalr	1458(ra) # 5bd8 <pipe>
  pid3 = fork();
  ...
  if(pid3 == 0){
    ...
    4646:	5ae080e7          	jalr	1454(ra) # 5bf0 <close>
    ...
    468c:	540080e7          	jalr	1344(ra) # 5bc8 <exit>
  ...
  close(pfds[1]);
    ...
    46ac:	548080e7          	jalr	1352(ra) # 5bf0 <close>
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    46c2:	522080e7          	jalr	1314(ra) # 5be0 <read>
    46c6:	4785                	li	a5,1
  ...
  close(pfds[0]);
    ...
    46f6:	4fe080e7          	jalr	1278(ra) # 5bf0 <close>
  printf("kill... ");
  ...
  kill(pid1);
    ...
    4710:	4ec080e7          	jalr	1260(ra) # 5bf8 <kill>
  kill(pid2);
    4714:	854e                	mv	a0,s3
    4716:	00001097          	auipc	ra,0x1
    471a:	4e2080e7          	jalr	1250(ra) # 5bf8 <kill>
  kill(pid3);
    471e:	8552                	mv	a0,s4
    4720:	00001097          	auipc	ra,0x1
    4724:	4d8080e7          	jalr	1240(ra) # 5bf8 <kill>
  printf("wait... ");
  ...
  wait(0);
    ...
    473e:	496080e7          	jalr	1174(ra) # 5bd0 <wait>
  wait(0);
    4742:	4501                	li	a0,0
    4744:	00001097          	auipc	ra,0x1
    4748:	48c080e7          	jalr	1164(ra) # 5bd0 <wait>
  wait(0);
    474c:	4501                	li	a0,0
    474e:	00001097          	auipc	ra,0x1
    4752:	482080e7          	jalr	1154(ra) # 5bd0 <wait>
...
0000000000004758 <reparent>:
{
  ...
  int master_pid = getpid();
    ...
    476e:	4de080e7          	jalr	1246(ra) # 5c48 <getpid>
    4772:	8a2a                	mv	s4,a0
    ...
    478e:	446080e7          	jalr	1094(ra) # 5bd0 <wait>
  ...
  exit(0);
    ...
    47a2:	42a080e7          	jalr	1066(ra) # 5bc8 <exit>
      printf("%s: fork failed\n", s);
    47a6:	85ce                	mv	a1,s3
    ...
    47be:	40e080e7          	jalr	1038(ra) # 5bc8 <exit>
        printf("%s: wait wrong pid\n", s);
    47c2:	85ce                	mv	a1,s3
    ...
    47da:	3f2080e7          	jalr	1010(ra) # 5bc8 <exit>
      int pid2 = fork();
    ...
    47f0:	3dc080e7          	jalr	988(ra) # 5bc8 <exit>
        kill(master_pid);
    47f4:	8552                	mv	a0,s4
    47f6:	00001097          	auipc	ra,0x1
    47fa:	402080e7          	jalr	1026(ra) # 5bf8 <kill>
        exit(1);
    47fe:	4505                	li	a0,1
    4800:	00001097          	auipc	ra,0x1
    4804:	3c8080e7          	jalr	968(ra) # 5bc8 <exit>
...
0000000000004808 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    4824:	3b8080e7          	jalr	952(ra) # 5bd8 <pipe>
    ...
    487e:	36e080e7          	jalr	878(ra) # 5be8 <write>
      for(;;) sleep(1000);
    4882:	3e800513          	li	a0,1000
    4886:	00001097          	auipc	ra,0x1
    488a:	3d2080e7          	jalr	978(ra) # 5c58 <sleep>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    48dc:	320080e7          	jalr	800(ra) # 5bf8 <kill>
    wait(0);
    48e0:	4501                	li	a0,0
    48e2:	00001097          	auipc	ra,0x1
    48e6:	2ee080e7          	jalr	750(ra) # 5bd0 <wait>
  ...
  wait(&xstatus);
    ...
    490a:	2ca080e7          	jalr	714(ra) # 5bd0 <wait>
  if(xstatus != -1 && xstatus != 2)
    ...
    4948:	284080e7          	jalr	644(ra) # 5bc8 <exit>
    printf("%s: fork failed\n", s);
    494c:	85d6                	mv	a1,s5
    ...
    4964:	268080e7          	jalr	616(ra) # 5bc8 <exit>
    a = sbrk(0);
    4968:	4501                	li	a0,0
    496a:	00001097          	auipc	ra,0x1
    496e:	2e6080e7          	jalr	742(ra) # 5c50 <sbrk>
    4972:	892a                	mv	s2,a0
    sbrk(10*BIG);
    4974:	3e800537          	lui	a0,0x3e800
    4978:	00001097          	auipc	ra,0x1
    497c:	2d8080e7          	jalr	728(ra) # 5c50 <sbrk>
    ...
    49b0:	21c080e7          	jalr	540(ra) # 5bc8 <exit>
    exit(1);
    49b4:	4505                	li	a0,1
    49b6:	00001097          	auipc	ra,0x1
    49ba:	212080e7          	jalr	530(ra) # 5bc8 <exit>
...
00000000000049be <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    49e8:	1ec080e7          	jalr	492(ra) # 5bd0 <wait>
    if(xstatus == -1){
    ...
    49fa:	1d2080e7          	jalr	466(ra) # 5bc8 <exit>
      *(char**)m2 = m1;
    ...
    4a38:	194080e7          	jalr	404(ra) # 5bc8 <exit>
    ...
    4a54:	178080e7          	jalr	376(ra) # 5bc8 <exit>
      exit(0);
    4a58:	4501                	li	a0,0
    4a5a:	00001097          	auipc	ra,0x1
    4a5e:	16e080e7          	jalr	366(ra) # 5bc8 <exit>
...
0000000000004a62 <sharedfd>:
{
  ...
  unlink("sharedfd");
    ...
    4a86:	196080e7          	jalr	406(ra) # 5c18 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
    ...
    4a9a:	172080e7          	jalr	370(ra) # 5c08 <open>
  if(fd < 0){
  ...
  memset(buf, pid==0?'c':'p', sizeof(buf));
    ...
    4ad6:	116080e7          	jalr	278(ra) # 5be8 <write>
    4ada:	47a9                	li	a5,10
  ...
  if(pid == 0) {
    ...
    4aee:	0de080e7          	jalr	222(ra) # 5bc8 <exit>
    ...
    4b0a:	0c2080e7          	jalr	194(ra) # 5bc8 <exit>
    ...
    4b26:	0a6080e7          	jalr	166(ra) # 5bc8 <exit>
    wait(&xstatus);
    4b2a:	f9c40513          	addi	a0,s0,-100
    4b2e:	00001097          	auipc	ra,0x1
    4b32:	0a2080e7          	jalr	162(ra) # 5bd0 <wait>
    if(xstatus != 0)
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    4b84:	060080e7          	jalr	96(ra) # 5be0 <read>
    ...
    4baa:	022080e7          	jalr	34(ra) # 5bc8 <exit>
        nc++;
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    4c0c:	fc0080e7          	jalr	-64(ra) # 5bc8 <exit>
    exit(0);
    4c10:	4501                	li	a0,0
    4c12:	00001097          	auipc	ra,0x1
    4c16:	fb6080e7          	jalr	-74(ra) # 5bc8 <exit>
...
0000000000004c1a <fourfiles>:
{
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    4c80:	f9c080e7          	jalr	-100(ra) # 5c18 <unlink>
    pid = fork();
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    4ca4:	f30080e7          	jalr	-208(ra) # 5bd0 <wait>
    if(xstatus != 0)
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4cee:	ede080e7          	jalr	-290(ra) # 5bc8 <exit>
      fd = open(fname, O_CREATE | O_RDWR);
    4cf2:	20200593          	li	a1,514
    4cf6:	854e                	mv	a0,s3
    4cf8:	00001097          	auipc	ra,0x1
    4cfc:	f10080e7          	jalr	-240(ra) # 5c08 <open>
    4d00:	892a                	mv	s2,a0
      if(fd < 0){
    ...
    4d34:	eb8080e7          	jalr	-328(ra) # 5be8 <write>
    4d38:	85aa                	mv	a1,a0
    ...
    4d4c:	e80080e7          	jalr	-384(ra) # 5bc8 <exit>
    ...
    4d6a:	e62080e7          	jalr	-414(ra) # 5bc8 <exit>
    ...
    4d84:	e48080e7          	jalr	-440(ra) # 5bc8 <exit>
      exit(xstatus);
    4d88:	855a                	mv	a0,s6
    4d8a:	00001097          	auipc	ra,0x1
    4d8e:	e3e080e7          	jalr	-450(ra) # 5bc8 <exit>
          printf("wrong char\n", s);
    ...
    4dac:	e20080e7          	jalr	-480(ra) # 5bc8 <exit>
      total += n;
    ...
    4dbe:	e26080e7          	jalr	-474(ra) # 5be0 <read>
    ...
    4dee:	e06080e7          	jalr	-506(ra) # 5bf0 <close>
    if(total != N*SZ){
    4df2:	03b91863          	bne	s2,s11,4e22 <fourfiles+0x208>
    unlink(fname);
    4df6:	8566                	mv	a0,s9
    4df8:	00001097          	auipc	ra,0x1
    4dfc:	e20080e7          	jalr	-480(ra) # 5c18 <unlink>
  for(i = 0; i < NCHILD; i++){
    ...
    4e14:	df8080e7          	jalr	-520(ra) # 5c08 <open>
    4e18:	89aa                	mv	s3,a0
    total = 0;
    4e1a:	895a                	mv	s2,s6
        if(buf[j] != '0'+i){
    ...
    4e3a:	d92080e7          	jalr	-622(ra) # 5bc8 <exit>
}
...
0000000000004e5c <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4e9e:	d8e080e7          	jalr	-626(ra) # 5c28 <link>
    if(pid == 0) {
    ...
    4ebc:	d50080e7          	jalr	-688(ra) # 5c08 <open>
      if(fd < 0){
    ...
    4ede:	cee080e7          	jalr	-786(ra) # 5bc8 <exit>
      link("C0", file);
    ...
    4ef2:	d3a080e7          	jalr	-710(ra) # 5c28 <link>
      exit(0);
    4ef6:	4501                	li	a0,0
    4ef8:	00001097          	auipc	ra,0x1
    4efc:	cd0080e7          	jalr	-816(ra) # 5bc8 <exit>
        exit(1);
    4f00:	4505                	li	a0,1
    4f02:	00001097          	auipc	ra,0x1
    4f06:	cc6080e7          	jalr	-826(ra) # 5bc8 <exit>
  ...
  fd = open(".", 0);
    ...
    4f2a:	ce2080e7          	jalr	-798(ra) # 5c08 <open>
    4f2e:	892a                	mv	s2,a0
  n = 0;
    4f30:	8aa6                	mv	s5,s1
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4f48:	c9c080e7          	jalr	-868(ra) # 5be0 <read>
    ...
    4fac:	c20080e7          	jalr	-992(ra) # 5bc8 <exit>
    ...
    4fcc:	c00080e7          	jalr	-1024(ra) # 5bc8 <exit>
  close(fd);
    4fd0:	854a                	mv	a0,s2
    4fd2:	00001097          	auipc	ra,0x1
    4fd6:	c1e080e7          	jalr	-994(ra) # 5bf0 <close>
  if(n != N){
  ...
  for(i = 0; i < N; i++){
    ...
    5004:	bc8080e7          	jalr	-1080(ra) # 5bc8 <exit>
      printf("%s: fork failed\n", s);
    5008:	85ce                	mv	a1,s3
  ...
  for(i = 0; i < N; i++){
    ...
    5174:	aa8080e7          	jalr	-1368(ra) # 5c18 <unlink>
    pid = fork();
    ...
    5198:	a74080e7          	jalr	-1420(ra) # 5c08 <open>
      if(fd < 0){
...
00000000000051b8 <bigfile>:
{
  ...
  unlink("bigfile.dat");
    ...
    51d8:	a44080e7          	jalr	-1468(ra) # 5c18 <unlink>
  fd = open("bigfile.dat", O_CREATE | O_RDWR);
    ...
    51ec:	a20080e7          	jalr	-1504(ra) # 5c08 <open>
    51f0:	89aa                	mv	s3,a0
  for(i = 0; i < N; i++){
    51f2:	4481                	li	s1,0
    memset(buf, i, SZ);
  ...
  if(fd < 0){
    ...
    521e:	9ce080e7          	jalr	-1586(ra) # 5be8 <write>
  ...
  if(fd < 0){
    ...
    526a:	97a080e7          	jalr	-1670(ra) # 5be0 <read>
    if(cc < 0){
  ...
  for(i = 0; ; i++){
    ...
    52b6:	916080e7          	jalr	-1770(ra) # 5bc8 <exit>
    ...
    52d2:	8fa080e7          	jalr	-1798(ra) # 5bc8 <exit>
    ...
    52ee:	8de080e7          	jalr	-1826(ra) # 5bc8 <exit>
    ...
    530a:	8c2080e7          	jalr	-1854(ra) # 5bc8 <exit>
    ...
    5326:	8a6080e7          	jalr	-1882(ra) # 5bc8 <exit>
    ...
    5342:	88a080e7          	jalr	-1910(ra) # 5bc8 <exit>
  close(fd);
    5346:	8552                	mv	a0,s4
    5348:	00001097          	auipc	ra,0x1
    534c:	8a8080e7          	jalr	-1880(ra) # 5bf0 <close>
  if(total != N*SZ){
  ...
  unlink("bigfile.dat");
    ...
    5366:	8b6080e7          	jalr	-1866(ra) # 5c18 <unlink>
}
    ...
    5394:	838080e7          	jalr	-1992(ra) # 5bc8 <exit>
...
0000000000005398 <fsfull>:
{
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    5442:	7ca080e7          	jalr	1994(ra) # 5c08 <open>
    5446:	892a                	mv	s2,a0
    if(fd < 0){
  ...
  while(nfiles >= 0){
    ...
    54bc:	760080e7          	jalr	1888(ra) # 5c18 <unlink>
    nfiles--;
  ...
  printf("fsfull test finished\n");
    ...
    5506:	6e6080e7          	jalr	1766(ra) # 5be8 <write>
      if(cc < BSIZE)
    ...
    552c:	6c8080e7          	jalr	1736(ra) # 5bf0 <close>
    if(total == 0)
...
run(void f(char *), char *s) {
  ...
  if(pid == 0) {
    ...
    556e:	666080e7          	jalr	1638(ra) # 5bd0 <wait>
    if(xstatus != 0) 
    ...
    55b2:	61a080e7          	jalr	1562(ra) # 5bc8 <exit>
    f(s);
    55b6:	854a                	mv	a0,s2
    55b8:	9482                	jalr	s1
    exit(0);
    ...
    55c0:	60c080e7          	jalr	1548(ra) # 5bc8 <exit>
      printf("OK\n");
...
countfree()
{
  ...
  if(pipe(fds) < 0){
    ...
    5648:	594080e7          	jalr	1428(ra) # 5bd8 <pipe>
  ...
  if(pid == 0){
    ...
    5666:	58e080e7          	jalr	1422(ra) # 5bf0 <close>
    ...
    567c:	5d8080e7          	jalr	1496(ra) # 5c50 <sbrk>
      if(a == 0xffffffffffffffff){
    ...
    5698:	554080e7          	jalr	1364(ra) # 5be8 <write>
    ...
    56b6:	516080e7          	jalr	1302(ra) # 5bc8 <exit>
    printf("pipe() failed in countfree()\n");
    ...
    56d0:	4fc080e7          	jalr	1276(ra) # 5bc8 <exit>
    printf("fork failed in countfree()\n");
    ...
    56ea:	4e2080e7          	jalr	1250(ra) # 5bc8 <exit>
      }
    }
    ...
    56f4:	4d8080e7          	jalr	1240(ra) # 5bc8 <exit>
  }

  close(fds[1]);
    56f8:	fcc42503          	lw	a0,-52(s0)
    56fc:	00000097          	auipc	ra,0x0
    5700:	4f4080e7          	jalr	1268(ra) # 5bf0 <close>
  ...
  while(1){
    ...
    5714:	4d0080e7          	jalr	1232(ra) # 5be0 <read>
    if(cc < 0){
  ...
  while(1){
    ...
    5738:	494080e7          	jalr	1172(ra) # 5bc8 <exit>
  }

  close(fds[0]);
    573c:	fc842503          	lw	a0,-56(s0)
    5740:	00000097          	auipc	ra,0x0
    5744:	4b0080e7          	jalr	1200(ra) # 5bf0 <close>
  wait((int*)0);
    5748:	4501                	li	a0,0
    574a:	00000097          	auipc	ra,0x0
    574e:	486080e7          	jalr	1158(ra) # 5bd0 <wait>
...
main(int argc, char *argv[])
{
  ...
  if (drivetests(quick, continuous, justone)) {
    ...
    5894:	338080e7          	jalr	824(ra) # 5bc8 <exit>
    5898:	892e                	mv	s2,a1
  if(argc == 2 && strcmp(argv[1], "-q") == 0){
  ...
  int continuous = 0;
    ...
    590a:	2c2080e7          	jalr	706(ra) # 5bc8 <exit>
  char *justone = 0;
    590e:	4601                	li	a2,0
    quick = 1;
    5910:	4505                	li	a0,1
  ...
  exit(0);
    ...
    5936:	296080e7          	jalr	662(ra) # 5bc8 <exit>
...
_main()
{
  ...
  exit(0);
    ...
    5950:	27c080e7          	jalr	636(ra) # 5bc8 <exit>
...
gets(char *buf, int max)
{
  ...
  for(i=0; i+1 < max; ){
    ...
    5a42:	1a2080e7          	jalr	418(ra) # 5be0 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
    ...
    5a94:	178080e7          	jalr	376(ra) # 5c08 <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
    ...
    5aa4:	180080e7          	jalr	384(ra) # 5c20 <fstat>
    5aa8:	892a                	mv	s2,a0
  close(fd);
    5aaa:	8526                	mv	a0,s1
    5aac:	00000097          	auipc	ra,0x0
    5ab0:	144080e7          	jalr	324(ra) # 5bf0 <close>
  return r;
}
    5ab4:	854a                	mv	a0,s2
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
    ...
    5ca6:	f46080e7          	jalr	-186(ra) # 5be8 <write>
}
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    60fc:	b58080e7          	jalr	-1192(ra) # 5c50 <sbrk>
  if(p == (char*)-1)
