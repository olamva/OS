...
000000000000011a <grep>:
{
 ...
 180:	3d0080e7          	jalr	976(ra) # 54c <write>
 ...
 198:	3b0080e7          	jalr	944(ra) # 544 <read>
...
00000000000001de <main>:
{
 ...
 21e:	352080e7          	jalr	850(ra) # 56c <open>
 222:	84aa                	mv	s1,a0
 ...
 23a:	31e080e7          	jalr	798(ra) # 554 <close>
  for(i = 2; i < argc; i++){
 ...
 24a:	2e6080e7          	jalr	742(ra) # 52c <exit>
 ...
 266:	2ca080e7          	jalr	714(ra) # 52c <exit>
    grep(pattern, 0);
 26a:	4581                	li	a1,0
 26c:	8552                	mv	a0,s4
 ...
 27c:	2b4080e7          	jalr	692(ra) # 52c <exit>
 ...
 29a:	296080e7          	jalr	662(ra) # 52c <exit>
...
_main()
{
 ...
 2b4:	27c080e7          	jalr	636(ra) # 52c <exit>
...
gets(char *buf, int max)
{
 ...
 3a6:	1a2080e7          	jalr	418(ra) # 544 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 3f8:	178080e7          	jalr	376(ra) # 56c <open>
  if(fd < 0)
 ...
 408:	180080e7          	jalr	384(ra) # 584 <fstat>
 40c:	892a                	mv	s2,a0
  close(fd);
 40e:	8526                	mv	a0,s1
 410:	00000097          	auipc	ra,0x0
 414:	144080e7          	jalr	324(ra) # 554 <close>
  return r;
}
 418:	854a                	mv	a0,s2
...
putc(int fd, char c)
{
 ...
 60a:	f46080e7          	jalr	-186(ra) # 54c <write>
}
...
malloc(uint nbytes)
{
 ...
 a60:	b58080e7          	jalr	-1192(ra) # 5b4 <sbrk>
  if(p == (char*)-1)
