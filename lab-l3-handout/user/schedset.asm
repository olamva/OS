...
int main(int argc, char *argv[])
{
  ...
  12:	81250513          	addi	a0,a0,-2030 # 820 <malloc+0xf4>
  16:	00000097          	auipc	ra,0x0
  1a:	65e080e7          	jalr	1630(ra) # 674 <printf>
        exit(1);
  1e:	4505                	li	a0,1
  20:	00000097          	auipc	ra,0x0
  24:	2b2080e7          	jalr	690(ra) # 2d2 <exit>
    }
  ...
  36:	350080e7          	jalr	848(ra) # 382 <schedset>
    exit(0);
  3a:	4501                	li	a0,0
...
_main()
{
  ...
  5a:	27c080e7          	jalr	636(ra) # 2d2 <exit>
...
gets(char *buf, int max)
{
 ...
 14c:	1a2080e7          	jalr	418(ra) # 2ea <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 19e:	178080e7          	jalr	376(ra) # 312 <open>
  if(fd < 0)
 ...
 1ae:	180080e7          	jalr	384(ra) # 32a <fstat>
 1b2:	892a                	mv	s2,a0
  close(fd);
 1b4:	8526                	mv	a0,s1
 1b6:	00000097          	auipc	ra,0x0
 1ba:	144080e7          	jalr	324(ra) # 2fa <close>
  return r;
}
 1be:	854a                	mv	a0,s2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3e2:	4c250513          	addi	a0,a0,1218 # 8a0 <digits>
 3e6:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4a2:	3aac8c93          	addi	s9,s9,938 # 848 <malloc+0x11c>
 ...
 4b0:	3f4b8b93          	addi	s7,s7,1012 # 8a0 <digits>
 ...
 5d6:	26e98993          	addi	s3,s3,622 # 840 <malloc+0x114>
        while(*s != 0){
 5da:	85ee                	mv	a1,s11
