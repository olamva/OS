...
putc(int fd, char c)
{
 ...
 478:	f46080e7          	jalr	-186(ra) # 3ba <write>
}
...
malloc(uint nbytes)
{
 ...
 8ce:	b58080e7          	jalr	-1192(ra) # 422 <sbrk>
  if(p == (char*)-1)
