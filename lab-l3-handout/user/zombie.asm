...
putc(int fd, char c)
{
 ...
 396:	f46080e7          	jalr	-186(ra) # 2d8 <write>
}
...
malloc(uint nbytes)
{
 ...
 7ec:	b58080e7          	jalr	-1192(ra) # 340 <sbrk>
  if(p == (char*)-1)
