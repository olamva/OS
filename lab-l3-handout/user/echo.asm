...
_main()
{
  ...
  9a:	27c080e7          	jalr	636(ra) # 312 <exit>
...
gets(char *buf, int max)
{
 ...
 18c:	1a2080e7          	jalr	418(ra) # 32a <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 1de:	178080e7          	jalr	376(ra) # 352 <open>
  if(fd < 0)
 ...
 1ee:	180080e7          	jalr	384(ra) # 36a <fstat>
 1f2:	892a                	mv	s2,a0
  close(fd);
 1f4:	8526                	mv	a0,s1
 1f6:	00000097          	auipc	ra,0x0
 1fa:	144080e7          	jalr	324(ra) # 33a <close>
  return r;
}
 1fe:	854a                	mv	a0,s2
...
malloc(uint nbytes)
{
 ...
 846:	b58080e7          	jalr	-1192(ra) # 39a <sbrk>
  if(p == (char*)-1)
