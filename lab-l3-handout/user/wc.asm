...
_main()
{
 ...
 1ac:	27c080e7          	jalr	636(ra) # 424 <exit>
...
gets(char *buf, int max)
{
 ...
 29e:	1a2080e7          	jalr	418(ra) # 43c <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 2f0:	178080e7          	jalr	376(ra) # 464 <open>
  if(fd < 0)
 ...
 300:	180080e7          	jalr	384(ra) # 47c <fstat>
 304:	892a                	mv	s2,a0
  close(fd);
 306:	8526                	mv	a0,s1
 308:	00000097          	auipc	ra,0x0
 30c:	144080e7          	jalr	324(ra) # 44c <close>
  return r;
}
 310:	854a                	mv	a0,s2
...
putc(int fd, char c)
{
 ...
 502:	f46080e7          	jalr	-186(ra) # 444 <write>
}
...
malloc(uint nbytes)
{
 ...
 958:	b58080e7          	jalr	-1192(ra) # 4ac <sbrk>
  if(p == (char*)-1)
