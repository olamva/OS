...
ls(char *path)
{
  ...
  de:	4ca080e7          	jalr	1226(ra) # 5a4 <open>
  ...
  f0:	4d0080e7          	jalr	1232(ra) # 5bc <fstat>
 ...
 13e:	452080e7          	jalr	1106(ra) # 58c <close>
}
 ...
 194:	3fc080e7          	jalr	1020(ra) # 58c <close>
    return;
 ...
 21e:	362080e7          	jalr	866(ra) # 57c <read>
 222:	47c1                	li	a5,16
...
main(int argc, char *argv[])
{
 ...
 2b8:	2b0080e7          	jalr	688(ra) # 564 <exit>
    ls(".");
...
_main()
{
 ...
 2ec:	27c080e7          	jalr	636(ra) # 564 <exit>
...
gets(char *buf, int max)
{
 ...
 3de:	1a2080e7          	jalr	418(ra) # 57c <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 430:	178080e7          	jalr	376(ra) # 5a4 <open>
  if(fd < 0)
 ...
 440:	180080e7          	jalr	384(ra) # 5bc <fstat>
 444:	892a                	mv	s2,a0
  close(fd);
 446:	8526                	mv	a0,s1
 448:	00000097          	auipc	ra,0x0
 44c:	144080e7          	jalr	324(ra) # 58c <close>
  return r;
}
 450:	854a                	mv	a0,s2
...
putc(int fd, char c)
{
 ...
 642:	f46080e7          	jalr	-186(ra) # 584 <write>
}
...
malloc(uint nbytes)
{
 ...
 a98:	b58080e7          	jalr	-1192(ra) # 5ec <sbrk>
  if(p == (char*)-1)
