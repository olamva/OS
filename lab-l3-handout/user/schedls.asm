...
int main(void)
{
   ...
   c:	348080e7          	jalr	840(ra) # 350 <schedls>
    exit(0);
  10:	4501                	li	a0,0
  12:	00000097          	auipc	ra,0x0
  16:	296080e7          	jalr	662(ra) # 2a8 <exit>
...
_main()
{
  ...
  30:	27c080e7          	jalr	636(ra) # 2a8 <exit>
...
gets(char *buf, int max)
{
 ...
 122:	1a2080e7          	jalr	418(ra) # 2c0 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 174:	178080e7          	jalr	376(ra) # 2e8 <open>
  if(fd < 0)
 ...
 184:	180080e7          	jalr	384(ra) # 300 <fstat>
 188:	892a                	mv	s2,a0
  close(fd);
 18a:	8526                	mv	a0,s1
 18c:	00000097          	auipc	ra,0x0
 190:	144080e7          	jalr	324(ra) # 2d0 <close>
  return r;
}
 194:	854a                	mv	a0,s2
