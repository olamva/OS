...
putc(int fd, char c)
{
 ...
 3d0:	f46080e7          	jalr	-186(ra) # 312 <write>
}
...
malloc(uint nbytes)
{
 ...
 826:	b58080e7          	jalr	-1192(ra) # 37a <sbrk>
  if(p == (char*)-1)
